(function(m, u, A) {
    ...
    function Ob(a, b, c, d, f) {
        ...
        function r(a, e) {
            for (e = Math.max(0, e | 0); 127 < e; )
                h.mergeArrays(a, [e & 127 | 128]),
                e >>= 7;
            h.mergeArrays(a, [e])
        }
        function t(a, e) {
        ...
        function B(a) {
            ...
            a: {
                ...
                for (var H = 0; H < z.length; H++)
                    if ((!z[H].id || "string" != typeof z[H].id) && w.calcAttribChecksum(z[H]) == B && w.calcTextChecksum(z[H]) == k) {
                        z = !0;
                        break a
                    }
                z = !1
        ...
        function q(a, e, b, c, k, d) {
            for (var f; b && (f = w.getElementSize(b)) && (!f[0] || !f[1]); )
                b = w.getElementParent(b);
            if (!b)
                return null;
            f = b[V];
            if (!f || 0 > f)
            ...
            /^mouse(up|down)|click$/.test(e) && (a = k || d,
            g(b, 2 > a ? 1 : a == (k ? 2 : 4) ? 4 : 2));
            return b
        }
        ...
        function e(a, e) {
            ...
            if (0 == e.length)
                ...
                100 >= e.length ? (b = e,
                c = "") : 200 >= e.length ? (b = e.substr(0, 100),
                c = e.substr(100)) : (b = e.substr(0, 97),
                c = e.substr(e.length - 97));
            var k = [];
            if (n(k, 29))
                return null;
            r(k, a);
        ...
        function N(a) {
            var e = a[V];
            if (!e || 0 > e || !/^INPUT|SELECT|TEXTAREA$/.test(a.nodeName) || !a.form || A(a.form))
                return null;
                    ...
                    if (e[V])
                        ...
                        if (b) {
                            ...
                            for (var c = b.length, k = 0; k < c; k++)
                                /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(b[k].tagName) && !b[k][V] && x(b[k])
                        } else
                            x(e)
                    }
                else
        ...
        function fa(a) {
            Ha && !Aa && 0 !== a.which && (O(a, a.charCode || a.keyCode, rb(a)),
            Aa = !0,
            h.setTimeout(function() {
                Aa = !1
            }, 1, "fvl.keyPress"))
        ...
        function W() {
            if (m.getSelection) {
                ...
                u.selection && u.selection.createRange && (a = u.selection.createRange(),
                b = a.text,
                c = a.parentElement());
            if ("string" == typeof b) {
                try {
                ...
                if (c) {
                    ...
                    for (var k = 0; k < c.length && !a; )
                        a = ba(c[k]).privateFlag || ma(c[k], !0),
                        k++;
                    b != Na && (Na = b,
                    b = a ? h.map(function() {
                        return la.obfuscatedSymbol
                    }, b.split("")).join("") : b,
                    da(e, [v.nowEventTime(), b]))
                }
            }
        }
        function Z() {
            Oa || (Oa = !0,
            Na && da(D, [v.nowEventTime()]),
            h.setTimeout(function() {
                Oa = !1
            }, 1, "fvl.copy"))
        }
                ...
                if (a[V])
                    ...
                    if (e) {
                        ...
                        for (var b = e.length, c = 0; c < b; c++)
                            /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(e[c].tagName) && !e[c][V] && x(e[c])
                    } else
                        x(a)
                }
        ...
        function G(a) {
            (a = X.getTarget(a)) && /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(a.tagName) && (x(a),
            da(Ta, [v.nowEventTime(), a]))
        }
        function J(a) {
        ...
        function M(a) {
            if ((a = X.getTarget(a)) && !A(a) && "FORM" == a.nodeName) {
                for (var e = a.elements, b = 0; b < e.length; b++)
                    w.isEmptyField(e[b]) || x(e[b]);
        ...
        if (!h.isMetrikaPlayer()) {
            ...
            if (w.getBody())
                y.on(u, "mouseleave", I);
            u.attachEvent && !m.opera ? (y.on(u, "focusin", E),
            y.on(u, "focusout", K)) : (y.on(m, "focus", P),
            y.on(m, "blur", C),
            y.on(u, "blur", C));
            u.addEventListener ? (y.on(u, "focus", F),
            y.on(u, "blur", G),
            y.on(u, "change", J),
            y.on(u, "submit", M)) : u.attachEvent && (y.on(u, "focusin", F),
            y.on(u, "focusout", G),
            function() {
                for (var a = u.getElementsByTagName("form"), e = 0; e < a.length; e++) {
                    for (var b = a[e].getElementsByTagName("*"), c = 0; c < b.length; c++)
                        if (/^INPUT|SELECT|TEXTAREA$/.test(b[c].tagName))
                            y.on(b[c], "change", J);
                    y.on(a[e], "submit", M)
                }
            }());
            (function() {
                ...
                if (a.length)
                    for (var e = 0; e < a.length; e++) {
                        var b = a[e].submit;
                        if ("function" == typeof b || "object" == typeof b && /^\s*function submit\(\)/.test(String(b)))
                            a[e][Ua] = b,
                            a[e].submit = function() {
                                M({
                                    target: this
        ...
        return {
            ...
            stop: function() {
                ...
                y.un(m, "blur", C);
                y.un(u, "blur", C);
                u.removeEventListener ? (y.un(u, "focus", F),
                y.un(u, "blur", G),
                y.un(u, "change", J),
                y.un(u, "submit", M)) : u.detachEvent && (y.un(u, "focusin", F),
                y.un(u, "focusout", G),
                function() {
                    for (var a = u.getElementsByTagName("form"), e = 0; e < a.length; e++) {
                        for (var b = a[e].getElementsByTagName("*"), c = 0; c < b.length; c++)
                            /^INPUT|SELECT|TEXTAREA$/.test(b[c].tagName) && y.un(b[c], "change", J);
                        y.un(a[e], "submit", M)
                    }
                }());
                (function() {
                    for (var a = u.getElementsByTagName("form"), e = 0; e < a.length; e++)
                        a[e][Ua] && (a[e].submit = a[e][Ua])
                }
                )()
            }
        }
    ...
    function L() {
        for (var a = {}, b = "hash host hostname href pathname port protocol search".split(" "), c = b.length, d = c, f, l; d--; )
            a[b[d]] = "";
        try {
            for (f = m.location,
            d = c; d--; )
    ...
    function ub(a, b) {
        ...
        for (c = 0; c < b.length; c++)
            d.push(b[c].replace(/\^/g, "\\^").replace(/\$/g, "\\$").replace(/\./g, "\\.").replace(/\[/g, "\\[").replace(/\]/g, "\\]").replace(/\|/g, "\\|").replace(/\(/g, "\\(").replace(/\)/g, "\\)").replace(/\?/g, "\\?").replace(/\*/g, "\\*").replace(/\+/g, "\\+").replace(/\{/g, "\\{").replace(/\}/g, "\\}"));
    ...
    function vb() {
        ...
        if (b && (c = b.navigationStart))
            for (d = [b.domainLookupEnd - b.domainLookupStart, b.connectEnd - b.connectStart, b.responseStart - b.requestStart, b.responseEnd - b.responseStart, b.fetchStart - c, b.redirectEnd - b.redirectStart, b.redirectCount || a.navigation && a.navigation.redirectCount],
            d.push(b.domInteractive && b.domLoading ? b.domInteractive - b.domLoading : null),
            d.push(b.domContentLoadedEventStart && b.domContentLoadedEventEnd ? b.domContentLoadedEventEnd - b.domContentLoadedEventStart : null),
            d.push(b.domComplete ? b.domComplete - c : null),
            d.push(b.loadEventStart ? b.loadEventStart - c : null),
            d.push(b.loadEventStart && b.loadEventEnd ? b.loadEventEnd - b.loadEventStart : null),
            d.push(b.domContentLoadedEventStart ? b.domContentLoadedEventStart - c : null),
            a = 0; a < d.length; a++)
                b = d[a],
    ...
    function Tb(a) {
        ...
        if (c) {
            ...
            for (f = c.length; l < f; l++)
                null === d[l] ? b.push(d[l]) : b.push(c[l] === d[l] ? "" : d[l])
        } else
            b = d;
    ...
    function Vb() {
        ...
        if ("object" == typeof m.chrome && m.chrome.loadTimes) {
            if (b = m.chrome.loadTimes(),
            b.requestTime && b.firstPaintTime && m.performance && m.performance.timing)
                return Math.round(1E3 * b.firstPaintTime - m.performance.timing.navigationStart)
        } else if (m.performance && m.performance.timing && (b = m.performance.timing,
        ...
        if (wb)
                ...
                var r = c(2)
                  ...
                  , B = {
                    ...
                    toList: function(a) {
                        ...
                        for (var b = new g.List, e = 0; e < a.length; e++)
                            b.add(a[e]);
                        return b
                    },
                    addToArray: function(a) {
                        for (var b, e = arguments.length, c = Array(1 < e ? e - 1 : 0), d = 1; d < e; d++)
                            c[d - 1] = arguments[d];
                    ...
                    map: function(a, b) {
                        ...
                        if (r.ObjectUtils.isNative(e.map, "map"))
                            return e.map(b);
                    ...
                    includes: function(a, b, e) {
                        void 0 === e && (e = 0);
                        if (r.ObjectUtils.isNative(Array.prototype.includes, "includes"))
                            return a.includes(b, e);
            ...
            , function(a, b, c) {
                ...
                var n = {
                    ...
                    findNativeImplementation: function(a) {
                        if (this.isNative(f.a[a], a))
                            return f.a[a];
                        var b = ["webkit", "moz", "ms", "o"];
                        a = "" + a.slice(0, 1).toUpperCase() + a.slice(1);
                        for (var c = 0; c < b.length; c++) {
                            var d = "" + b[c] + a;
                            if (this.isNative(f.a[d], d))
                                return f.a[d]
                        }
                        return null
                    },
                    ...
                    isMonkeyPatchedOrUndefined: function(a, b) {
                        var c = f.a;
                        if (c[a] === A || !this.isNative(c[a], a))
                            return !0;
                        if (b)
                            for (var d = 0; d < b.length; d++)
                                if (!this.isNative(c[a].prototype[b[d]], b[d]))
                                    return !0;
                        return !1
                    },
            ...
            , function(a, b, c) {
                ...
                b.a = function() {
                    ...
                    if ("undefined" !== typeof u && u.body) {
                        ...
                        try {
                            /Trident|MSIE/.test(navigator.userAgent) ? u.body.parentNode && u.body.parentNode.appendChild(b) : u.body.appendChild(b),
                ...
                var d = c(4)
                  ...
                  , n = {
                        ...
                        if (a)
                            try {
                                ...
                                if (null === b)
                                    return !1;
                                if (b.defaultView)
                                    return a instanceof b.defaultView.Node
                            } catch (p) {
                    ...
                    elementsFromPoint: function(a, b, c) {
                        ...
                        for (a = g.length; b = g[--a]; )
                            d[a].style.setProperty("pointer-events", b.value ? b.value : "", b.priority);
                        return d
                    },
                    nodeIndentLevel: function(a) {
                        for (var b = 0; a.parentNode; )
                            a = a.parentNode,
                            b++;
                        return b
                    },
                    offsets: function(a, b) {
                        ...
                        var e = (a.ownerDocument || u).defaultView || m
                    ...
                    nodeIsInTree: function(a) {
                        if (this.isDOMNode(a)) {
                            var b = a.ownerDocument;
                            if (null != b)
                                return b.documentElement.contains(a)
                        }
                        return !1
                    },
                    waitForNode: function(a, b, c) {
                        ...
                        if (d.nodeIsInTree(a))
                            ...
                            var k = a.ownerDocument || u
                              , e = new MutationObserver(function() {
                                d.nodeIsInTree(a) && (b(!0),
                                e.disconnect())
                            }
                            );
            ...
            , function(a, b, c) {
                ...
                var p = c.IGNORED_NODES
                  ...
                  , m = function(a, b, e) {
                    ...
                    if ("function" === typeof b && c(a) === NodeFilter.FILTER_ACCEPT && (b(a),
                    !1 === z(a)))
                        for (a = u.createTreeWalker(a, -1, e ? {
                            acceptNode: c
                  ...
                  , Ma = function(a) {
                    ...
                    return function(a, b) {
                        if (a && b) {
                            ...
                            if (e)
                                return (e = c[e.toLowerCase()]) && !!b.match(e) || !!b.match(k)
                        }
                        return !1
                    }
                }(B)
                    ...
                    if (fb(a, b, c)) {
                        k = e.reduce(function(e, c) {
                            try {
                                ...
                                return t["default"].warn("Filtering error", W),
                                e
                            }
                        }, k);
                        if ("string" === typeof k)
                            return (c = D[b]) ? c(a, b, k) || k : k;
                        if (null != k && !1 !== k)
                            return k.baseVal
                    }
                    return null
                    ...
                    if (e && e.name) {
                        if (!1 !== x(b, e.name))
                            try {
                                ...
                                t["default"].warn("Error while reading attribute", e, a),
                                t["default"].warn(Y)
                            }
                    } else
                        t["default"].warn("Error while reading attribute", e, a);
                ...
                c = {
                    ...
                    each: function(a, b, e) {
                        a && (a = La(a, e),
                        g.IterableUtils.fastIterate(a, b))
                    },
                    ...
                    cloneAttributes: function(a, b) {
                        ...
                        g.IterableUtils.fastIterate(e, function(a, e) {
                            var c = !1 === r.Tools.isNULL(e.namespaceURI)
                              , k = e.cloneNode();
                            c ? b.attributes.setNamedItemNS(k) : b.attributes.setNamedItem(k)
                        });
                        return b
                    },
                    isSVG: y,
            ...
            , function(a, b, c) {
                ...
                var n = function() {
                    ...
                    ;
                    b.get = function(a) {
                        return (a = this.find(a)) ? a.value : A
                    }
                    ;
                    b.keys = function() {
                ...
                (function(a, f) {
                    var d = c(8)
                      ...
                      , r = function() {
                        ...
                        var c = b.prototype;
                        c.emit = function(a) {
                            for (var b = this, c = arguments.length, e = Array(1 < c ? c - 1 : 0), d = 1; d < c; d++)
                                e[d - 1] = arguments[d];
                        ...
                        c._invokeEvent = function(a, b, c) {
                            ...
                            if ((a = this._getNamespace(k, a)) && 0 < a.size) {
                                ...
                                g.IterableUtils.forof(a, function(a) {
                                    if (e._isAlreadyCalled(k, a))
                                        return !0;
                                    l = l.then(function(g) {
                                        return !1 !== g ? (g = e._runCallback(k, a, b),
                                        c(g),
                                        d ? g : null) : !1
                                    })
                                })
                        ...
                        c._saveEvent = function(a, b) {
                            ...
                            l.has(b) || (l.add(b),
                            this._events.set(e, l),
                            this._options.set(e, c),
                            this._saveNamespace(e, f, b),
                            q && this._runCallback(e, b, q))
                        }
                        ;
                        ...
                        c._setupEvents = function() {
                            var a = this;
                            this.allowedEvents.size && g.IterableUtils.forof(this.allowedEvents, function(b) {
                                var c = b.split(":");
                                b = c[0];
                                c = c.slice(1);
                        ...
                        c._removeEvent = function(a, b) {
                            ...
                            g.has(b) ? (c || g["delete"](b),
                            this._removeNamespace(e, c, b)) : (c || (this._events["delete"](e),
                            this._options["delete"](e)),
                        ...
                        c._removeNamespace = function(a, b) {
                            ...
                            e && (b ? (this._removeCallbacks(a, e.get(b)),
                            e["delete"](b)) : (g.IterableUtils.forof(e, function(b) {
                ...
                (function(a) {
                    ...
                    var d = c(4)
                      ...
                      , t = {
                        ...
                        copyText: function(b) {
                            return new a(function(a) {
                                var c = u.createElement("textarea")
                                  , k = u.body;
                                c.value = b;
                                c.style.opacity = "0";
                                ...
                                c.onselect = function() {
                                    try {
                                        c.onselect = null,
                                        u.execCommand && u.execCommand("copy"),
                                        a()
                                    } catch (e) {
                        ...
                        globalize: function(a, b) {
                            "undefined" !== typeof d.a && Object.defineProperty(d.a, b, {
                                value: a
                            })
                        },
                        guid: function() {
                        ...
                        requestAnimationFrame: function(a) {
                            ...
                            if (b && c)
                                return this.requestAnimationFrame = b.bind(m),
                        ...
                        cancelAnimationFrame: function(a) {
                            var b = g.ObjectUtils.findNativeImplementation("requestAnimationFrame")
                              , c = g.ObjectUtils.findNativeImplementation("cancelAnimationFrame");
                            b && c ? (this.cancelAnimationFrame = c.bind(m),
                        ...
                        errorProxy: function(a, b, c) {
                            ...
                            try {
                                ...
                                return m.console.warn("Error while running " + (c || a.name), k),
                                b
                            }
                        }
                    }
                  ...
                  , l = {
                    ...
                    stringToBlobURL: function(a, b, c) {
                        ...
                        var g = function() {
                          ...
                          , f = function(a) {
                            ...
                            /blob:(?!http[s]?).*/.test(a) ? a.replace("blob:", "blob:" + (c.protocol + "//" + c.host) + "/") : a) : A
                        }(g);
                        return g ? {
                            blob: g,
                            url: f
                    ...
                    parseURL: function(a) {
                        if (!a)
                            return A;
                        if ("string" !== typeof a)
                            return d.a.console.warn("URL was expected to be a string", a),
                            A;
                        ...
                        create: function(a, b) {
                            ...
                            g = {
                                ...
                                run: function(b) {
                                    ...
                                    if (!z) {
                                        k = b;
                                        for (var g = arguments.length, f = Array(1 < g ? g - 1 : 0), t = 1; t < g; t++)
                                            f[t - 1] = arguments[t];
                                        m = f;
                                        q && n ? (q = !1,
                                        D = b,
            ...
            , function(a, b, c) {
                ...
                var d = {
                    ...
                    lazy: function(a, b) {
                        ...
                        var c;
                        return function() {
                            for (var d = arguments.length, g = Array(d), f = 0; f < d; f++)
                                g[f] = arguments[f];
                            clearTimeout(c);
                            c = G(function() {
                                a.apply(void 0, g)
            ...
            , function(a, b, c) {
                var d = c(4)
                  ...
                  , l = function() {
                    var a = !1;
                    if (f.ObjectUtils.objectIsWindow(d.a))
                        try {
                  ...
                  , g = function(a, b, c, d, g) {
                    ...
                    a += "EventListener";
                    if (b && b[a])
                        return l ? b[a](c, d, g) : b[a](c, d, "boolean" === typeof g ? g : g.capture || !1)
                };
                a = function() {
                    function a() {}
            ...
            , function(a, b, c) {
                (function(a) {
                    ...
                    b.a = function(b) {
                        ...
                        if (l.ObjectUtils.isNative(d.a.Array.from, "from"))
                            return d.a.Array.from(b);
                        ...
                        try {
                            if (b.forEach)
                                ...
                                for (var p = b[a.iterator](), B, q; B = p.next(),
                                q = B.value,
                                !B.done; )
                                    c.push(q);
                            return c
                ...
                var d = c(4)
                  ...
                  , l = {
                    ...
                    scaleFactor: function(a, b) {
                        ...
                        return g > c || f > d ? (c /= g,
                        d /= f,
                        Math.min(1, Math.max(c > d ? .1 : .35, Math.min(c, d)))) : 1
                    },
                    ...
                    b.a = function(b, c) {
                        ...
                        if (b && c instanceof Function)
                            if (null != b[a.iterator])
                                ...
                                for (f = Object(d.a)(b),
                                n = 0; n < f.length && (B = f[n],
                                B = g ? c.apply(void 0, B) : c(B),
                                !0 === B || !1 !== B); n++)
                                    ;
                    }
                }
            ...
            , function(a, b, c) {
                (function(a, f, l) {
                    ...
                    var n = c(15)
                      ...
                      , p = new a
                      , B = HTMLCanvasElement.prototype.getContext
                      , q = function(a) {
                    ...
                    a = function() {
                        ...
                        a.mock = function() {
                            if (!this.mocked) {
                                ...
                                HTMLCanvasElement.prototype.getContext = function(b) {
                                    var c = B.call(this, b);
                                    if (null !== c)
                                        return !1 !== this.proxy && 0 <= t.indexOf(b) && a.update(c),
                                        c
                                }
                                ;
                        ...
                        a.remove = function() {
                            ...
                            this.events.off(),
                            HTMLCanvasElement.prototype.getContext = B)
                        }
                        ;
                        a.update = function(b) {
                            if (!1 === a.proxies.has(b)) {
                                var c = this
                                  ...
                                  , g = k(b);
                                f.nodeIsRecordable(e) && g.properties && (f.forof(g.properties, function(a) {
                                ...
                                f.forof(g.methods, function(a) {
                                    ...
                                    Object.defineProperty(b, a, {
                                        configurable: !0,
                                        value: function() {
                                            for (var d = arguments.length, k = Array(d), g = 0; g < d; g++)
                                                k[g] = arguments[g];
                    ...
                    d = function() {
                        ...
                        c._executeJobsAsync = function() {
                            ...
                            if (this.hasJobs) {
                                ...
                                this.executionFrameId = a.requestAnimationFrame(function() {
                                    for (; b.hasJobs && (!b.jobExecutionStartStamp || 150 > c); )
                                        c = b._executeJob(!b.jobExecutionStartStamp);
                        ...
                        c._executeJob = function(a) {
                            ...
                            try {
                                ...
                                n["default"].log("Error occurred when running job"),
                                n["default"].log(B),
                                n["default"].log(a.toString())
                            }
            ...
            , function(a, b, c) {
                (function(a) {
                    ...
                    b.a = function(b) {
                        ...
                        if (b.headers === A || b.headers["Content-Type"] === A)
                            c.headers = c.headers || {},
                            c.headers["Content-Type"] = function() {
                                switch (c.type) {
                                case "json":
            ...
            , function(a, b, c) {
                (function(a, c) {
                    var d = function() {
                      ...
                      , f = function(b) {
                        return b ? (b = this._getTime() - b,
                        0 > b && a.warn("Invalid stamp: " + b),
                        b) : 0
                    }
                      , r = function(a, b) {
                        var c;
                        ...
                        return {
                            ...
                            handleInputChangeValueEvent: function(a) {
                                ...
                                this.recorder.errorLogger(function() {
                                    ...
                                    if (d) {
                                        var e = d.id;
                                        if (!b.inputs[e] && (b.handleNodeIndex(d),
                                        !b.inputs[e]))
                                            return;
                            ...
                            handleInputValueChange: function(a, b, c) {
                                ...
                                if ((!b || -1 !== ["string", "boolean", "number"].indexOf(typeof b)) && b !== d) {
                                    if (e)
                                        c = this.recorder._getEventObject("change", a, {
                                            checked: !!b
                                        });
                                    else {
                ...
                (function(a, f) {
                    ...
                    b.a = function() {
                        var b = {
                          ...
                          , p = function(a) {
                            var b = this.stamp;
                            "mousemove" === a.type ? t.call(this, a, b) : l.call(this, {
                                object: a,
                                args: [b]
                            })
                        };
                    ...
                    b.a = function() {
                        var b = {
                          ...
                          , r = function(a) {
                            ...
                            b && b.start !== b.end && -1 !== ["mousemove", "touchmove", "touchdown"].indexOf(a.type) ? (f = !0,
                            a = this._getEventObject("selection", "select" === a.type ? a.target : this.rootNode, b),
                            this._publishActions(a)) : f && -1 !== ["mousedown", "touchmove", "touchdown"].indexOf(a.type) && (f = !1,
                        ...
                        var b = {
                          ...
                          , k = function(a) {
                            ...
                            a.changedTouches && 0 < a.changedTouches.length && l.forof(a.changedTouches, function(a) {
                                var b = void 0 === c ? !1 : c;
                                if (g.has(a.identifier))
                                    var e = g.get(a.identifier);
                                else
                                    e = l.guid(),
                                    g.set(a.identifier, e);
                ...
                (function(a) {
                    ...
                    d = function(b) {
                        ...
                        e.addChanges = function(b, c) {
                            for (var e = arguments.length, d = Array(2 < e ? e - 2 : 0), k = 2; k < e; k++)
                                d[k - 2] = arguments[k];
                        ...
                        d.collectSummary = function(a, b, c, d) {
                            ...
                            case "childList":
                                b = f.reduce(d.addedNodes, function(a, b) {
                                    !1 === c.added.has(b) && (a.push(b),
                                    p.c.walk(b, function(a) {
                        ...
                        c.mock = function() {
                            ...
                            p.IterableUtils.forof(h.methods, function(e) {
                                ...
                                Object.defineProperty(b, e, {
                                    configurable: !0,
                                    value: function() {
                                        for (var a, b = arguments.length, k = Array(b), g = 0; g < b; g++)
                                            k[g] = arguments[g];
                ...
                (function(a, f) {
                    ...
                    d = function(b) {
                        ...
                        d.addQuckAccessItem = function(a, b) {
                            null == this.quickAccess[a] && null == this[a] && (this.quickAccess[a] = b,
                            Object.defineProperty(this, a, {
                                get: function() {
                        ...
                        d.addToIndex = function(a, b, c) {
                            ...
                            if (a = this.middleware.run(a)) {
                                ...
                                if (!1 === this.dom.has(a) || null == e) {
                                    ...
                                    this.recorder && "INPUT" === d && (b = m.a.validate(a, this.recorder.options),
                                    d = b.forceRecord,
                                    b = !b.isAllowed && !d,
                                    d = e.attributes.value,
                                    e.attributes.value = b ? m.a.encode(d) : d,
                                    b && (e.hidden = !0));
                        ...
                        d.clear = function(a) {
                            ...
                            k.IterableUtils.forof(k.IterableUtils.keys(this.dom), function(a) {
                                k.IterableUtils.forof(["_DOMIndexerID", "_DOMIndexerInfo"], function(b) {
                                    a[b] = null;
                                    delete a[b]
                                })
                            });
                        ...
                        d.getIndexedNodeId = function(a) {
                            ...
                            return null == b ? (this.reindexNodeTree(a),
                            this.getNodeId(a)) : b
                        }
                        ;
                        ...
                        d.reindexNodeTree = function(a, b) {
                            ...
                            if (a) {
                                var l = [];
                                if (a.parentNode || f)
                                    g = D.FunctionUtils.toFunction(g),
                        ...
                        d.showMissingNodes = function(a) {
                            ...
                            a && H.Tools.measure("Show missing nodes", function() {
                                ...
                                k.IterableUtils.fastIterate(a, function(a, c) {
                    ...
                    p()(d, "toNodesTree", function(a) {
                        ...
                        k.IterableUtils.forof(a, function(a) {
                            if (null == b[a.id]) {
                                ...
                                b[a.id] = c;
                                null != a.parent && (a = b[a.parent]) && (a.children = a.children || [],
                                a.children.push(c))
                            }
                        });
                        return b[0]
            ...
            , function(a, b, c) {
                (function(a) {
                    ...
                    d = function() {
                        ...
                        var c = b.prototype;
                        c.send = function(a, b) {
                            var c = this, d = void 0 === b ? {} : b, k = d.data, g = d.onResponse, f = d.onTimeout, l = d.receiver, q = d.awaitResponse, n = d.timeoutTime, t = null, p = !1, h = !1, m, B = [], u = Date.now();
                            "function" === typeof g && (p = !0,
                            t = a + "." + this.timestamp,
                            this.listenOnce(function(a) {
                                var b = a.data
                                  ...
                                  , d = b.data;
                                if (b.type === t)
                                    e ? r["default"].warn("Seems like you forgot to call `answer` in a message handler. This message requires response.") : (h = !0,
                                    g(d, {
                                        origin: a.origin,
                            ...
                            if (null == this._cancelMainHandler) {
                                var b = this._attachEvent("message", function(b) {
                                    ...
                                    if (!0 === c._ym_messenger && g && !/\.([0-9]+)$/.test(g)) {
                                        ...
                                        if (null === f)
                                            r["default"].warn("Cannot find iframe with id " + d);
                                        else {
                                            var q = {
                                                id: d,
                                                sender: f,
                        ...
                        c._findIframe = function(b, c) {
                            var e = this
                              , d = [].slice.call(u.querySelectorAll("iframe"));
                            return a.find(d, function(a) {
                                if (a.contentWindow === b)
                                    return !0;
                                if (t.DOMUtils.isBlankOrSameOriginIframe(a, e.win))
                                    try {
            ...
            , function(a, b, c) {
                (function(a) {
                    ...
                    d = function() {
                        ...
                        ;
                        c.restorePageSelection = function(b) {
                            if (b) {
                ...
                (function(a) {
                    var d = c(4)
                      ...
                      , g = {
                        ...
                        localStorage: function() {
                            try {
                                return d.a.localStorage.setItem("test", "value"),
                                d.a.localStorage.removeItem("test"),
                                !0
                            } catch (n) {
                                return !1
                            }
                    ...
                    b.a = function() {
                        a.forin(g, function(a) {
                            if (!g[a]())
                                return l["default"].log("Feature not supported: " + a),
                                !1
                        });
                        return !0
                    }()
                ...
                (function(a) {
                    ...
                    var g = c(0)
                      ...
                      , t = {
                        ...
                        resetMultiple: function() {
                            for (var a, b = this, c = arguments.length, e = Array(c), d = 0; d < c; d++)
                                e[d] = arguments[d];
                    ...
                    d = Object.defineProperties({
                        ...
                        applyPatch: function(b, c) {
                            ...
                            d = b;
                            t.resetAll();
                            if (t.test("dataurlTest", b) || t.test("selectorTest", b))
                                return b;
                            t.test("protocolMissing", b) && (d = t.test("protocolIncomplete", b) ? b.replace(t.get("protocolIncomplete"), g + "//") : g + "//" + (k + "/" + e).replace(/\/\/+/, "/"));
                            q.set(b, d);
                            /http[s]?/.test(d) ? (k = d,
                            t.test("proxiedURL", k) ? d = k : (h.isWhitelisted ? (g = h.isWhitelisted(k)) && a.warn("Whitelisted: " + k) : g = !1,
                            d = g ? k : (g = h.proxy) && t.test("resourceFinder", g) ? g.replace(t.get("resourceFinder"), encodeURIComponent(k)) : k),
                            H.push(d),
                            B.set(b, d),
                            k = d) : (H.push(b),
                            B.set(b, d),
                        ...
                        isURLLike: function(a) {
                            t.resetMultiple(["dataurlTest", "selectorTest", "extnameFinder", "protocolMissing"]);
                        ...
                        return {
                            create: function(a) {
                                a.keyCapture.onCapture(function(b) {
                                    "OBJECT" === u.activeElement.nodeName && /flash/.test(u.getAttribute("type")) || (b = a._getEventObject("keystroke", -1, b),
                                    a._publishActions(b))
                                })
                            },
                            destroy: function(a) {
                        ...
                        var a, b = function(a, b) {
                            var c = 0
                              , e = function() {
                                ...
                                d && (0 !== d.stamp ? this._publishActions(d) : 3 > c && (G(e, 300),
                                c += 1))
                            }
                            .bind(this);
                            e()
            ...
            , function(a, b, c) {
                ...
                var d = c(12)
                  ...
                  , r = function(a, b) {
                    ...
                    a.attributes && (f.DOMUtils.copyAttributes(a, c),
                    ...
                    var ja = function(b) {
                        function c(c, d) {
                            ...
                            k._context = function(a) {
                                var b = {};
                                return a ? (b.window = a.window || m,
                                b.document = a.document || u,
                                b) : {
                                    window: m,
                                    document: u
                                }
                        ...
                        d.configure = function() {
                            ...
                            Y.c.addAttributesFilter(function(b, c, e) {
                                if (C.a.isValidNode(b) && "value" === c)
                                    return b = C.a.validate(b, a),
                                    c = b.forceRecord,
                                    b.isAllowed || c ? e : C.a.encode(e)
                            })
                        }
                        ;
                        d.attachEvent = function() {
                            for (var a, b = arguments.length, c = Array(b), e = 0; e < b; e++)
                                c[e] = arguments[e];
                                ...
                                return r.a.wrap(function(b) {
                                    for (; ; )
                                        ...
                                        case 5:
                                            ...
                                            this.ableToStart = !0,
                                            this.cancelIfNotStarted = G(function() {
                                                a.stop(!0, !1)
                                            }, 3E4),
                                            this.emit("ready"),
                                            this.inited = !0,
                        ...
                        d.__initIndexer = function() {
                            ...
                            if (p()({}, this.options).childIframe)
                                this.indexer.on("node", function(b) {
                        ...
                        d.connectSlaveRecorder = function(a) {
                            var b = this;
                            if ("IFRAME" === a.nodeName && a.name !== ca.a.NATIVE_IFRAME_NAME && Z.DOMUtils.isBlankOrSameOriginIframe(a, this.window)) {
                                try {
                                ...
                                var e = function eb(a) {
                                    ...
                                    if (c && e) {
                                        if (!0 === c.__YM_WV_RECORDABLE__)
                                            return K["default"].warn("Iframe has internal counter installed");
                                        if (!0 === c.__YM_RECORDING__)
                                            return K["default"].warn("We're already recording this iframe", a);
                                  ...
                                  , d = function(c) {
                                    b.errorLogger(function() {
                                        if (c && c.parentElement && c.contentDocument && Z.DOMUtils.isBlankOrSameOriginIframe(a, b.window) && !0 !== c.contentWindow.__WV_ENABLED__)
                                            try {
                                                e(c)
                                            } catch (eb) {
                                                K["default"].error(eb),
                                                K["default"].warn("Probably this iframe is cross-origin")
                                            }
                                    }, "ifLo")
                                };
                                        ...
                                        if (!b.inited)
                                            ...
                                            if (R && !Q) {
                                                ...
                                                b.sendSnapshot().then(function(a) {
                                                    a && (b._sendInitialEvents(),
                                                    b._sendPreCachedData(),
                                                    b._timer.start())
                                                })["catch"](function(a) {
                        ...
                        d.stop = function(a, b) {
                            ...
                            void 0 === a && (a = !1);
                            void 0 === b && (b = !0);
                            R && !Q && (!1 !== this.started && this.inited || a) && !0 !== this.stopped && (clearTimeout(this.cancelIfNotStarted),
                        ...
                        d._blockUpcomingCaptor = function(a, b) {
                            var c = this;
                            void 0 === b && (b = Infinity);
                            a && (this._blockedCaptors = this._blockedCaptors || new l,
                            this._blockedCaptors.add(a),
                            Infinity > b && G(function() {
                                ...
                                if (null != e) {
                                    ...
                                    if (c.events) {
                                        ...
                                        b = c.events.map(function(b) {
                                            /mouse/.test(b.type) && (b.meta.x = Math.round(b.meta.x + k),
                                            b.meta.y = Math.round(b.meta.y + g));
                                            return p()({}, b, d, {
                            ...
                            this.snapshot = {
                                get: function(c) {
                                    ...
                                    return b.then(function(b) {
                                        ...
                                        b = b.content;
                                        c ? (b = d.call(a, b, c),
                                        a.fatal("invalid-snapshot", c)) : b = e.call(a, b);
                                        return b
                                    })
                                }
                            }
                        ...
                        d._sendPreCachedData = function(a) {
                            ...
                            if (this.precache.length)
                                for (var b; null != (b = this.precache.shift()); )
                                    this._request(b[0], b[1], a)
                        }
                        ;
                        ...
                        d._universalHandler = function(a, b) {
                            var c = this
                              ...
                              , d = void 0 === e ? [] : e;
                            return function() {
                                for (var b = arguments.length, e = Array(b), k = 0; k < b; k++)
                                    e[k] = arguments[k];
            ...
            , function(a, b, c) {
                (function(b) {
                    var d = c(69), l = c(83), g = Object.create, n = Object.defineProperties, r = Object.defineProperty, h = Object.prototype, p, m = g(null);
                    if ("function" === typeof b) {
                        var q = b;
                        try {
                            String(q());
            ...
            , function(a, b, c) {
                ...
                (a.exports = function(a, b) {
                    ...
                    b = a,
                    a = null);
                    null == b ? b = A : l(b) ? null == c ? c = A : l(c) || (h = c,
                    c = A) : (h = b,
                    b = c = A);
                    if (null == a) {
                        var n = !0;
            ...
            , function(a, b, c) {
                (function(b) {
                    (function(b, c) {
                        ...
                        function x(b, c, e) {
                            c.constructor === b.constructor && e === q && c.constructor.resolve === k ? ca(b, c) : e === R ? (C(b, R.error),
                            R.error = null) : e === A ? v(b, c) : a(e) ? z(b, c, e) : v(b, c)
                        }
                        function w(a, b) {
                            if (a === b)
                                C(a, new TypeError("You cannot resolve a promise with itself"));
                            else {
                                var c = typeof b;
                        ...
                        function v(a, b) {
                            a._state === K && (a._result = b,
                            a._state = U,
                            0 !== a._subscribers.length && Y(F, a))
                        }
                        function C(a, b) {
                            a._state === K && (a._state = S,
                            a._result = b,
                            Y(y, a))
                        }
                        function E(a, b, c, e) {
                        ...
                        function F(a) {
                            var b = a._subscribers
                              , c = a._state;
                            if (0 !== b.length) {
                                for (var e, d, k = a._result, g = 0; g < b.length; g += 3)
                                    e = b[g],
                                    d = b[g + c],
                                    e ? J(c, e, d, k) : d(k);
                        ...
                        var ha = Math.random().toString(36).substring(2)
                          ...
                          , ea = function() {
                            function a(a, b) {
                                ...
                                T(b) ? (this._remaining = this.length = b.length,
                                this._result = Array(this.length),
                                0 === this.length ? v(this.promise, this._result) : (this.length = this.length || 0,
                                this._enumerate(b),
                                0 === this._remaining && v(this.promise, this._result))) : C(this.promise, Error("Array Methods must be provided an Array"))
                            }
                            a.prototype._enumerate = function(a) {
                                for (var b = 0; this._state === K && b < a.length; b++)
                            ...
                            a.prototype._eachEntry = function(a, b) {
                                var c = this._instanceConstructor
                                  , d = c.resolve;
                                d === k ? (d = D(a),
                                d === q && a._state !== K ? this._settledAt(a._state, b, a._result) : "function" !== typeof d ? (this._remaining--,
                                this._result[b] = a) : c === Q ? (c = new c(e),
                                x(c, a, d),
                            ...
                            a.prototype._settledAt = function(a, b, c) {
                                var e = this.promise;
                                e._state === K && (this._remaining--,
                                a === S ? C(e, c) : this._result[b] = c);
            ...
            , function(a, b, c) {
                (function(b, c) {
                    !function(d) {
                        ...
                        var x = Object.prototype, w = x.hasOwnProperty, y, v = "function" === typeof b ? b : {}, A = v.iterator || "@@iterator", C = v.asyncIterator || "@@asyncIterator", E = v.toStringTag || "@@toStringTag";
                        v = "object" === typeof a;
                        ...
                        if (F)
                            ...
                            ;
                            (v = (v = Object.getPrototypeOf) && v(v(ca([])))) && v !== x && w.call(v, A) && (d = v);
                            ...
                            ;
                            F.mark = function(a) {
                                Object.setPrototypeOf ? Object.setPrototypeOf(a, p) : (a.__proto__ = p,
                            ...
                            z.prototype = {
                                ...
                                reset: function(a) {
                                    ...
                                    if (!a)
                                        for (var b in this)
                                            "t" === b.charAt(0) && w.call(this, b) && !isNaN(+b.slice(1)) && (this[b] = y)
                                },
                                stop: function() {
                                    this.done = !0;
    ...
    ;
    v.isPerfomance || (v.deltaTime = 0,
    v.lastNowTime = 0,
    v.correctTime = 0,
    v.timeCorrector = function(a) {
    ...
    h.mergeArrays = function(a) {
        ...
        for (b = 1; b < d; b++) {
            var f = arguments[b];
            if (h.isArray(f) || f && "[object Arguments]" === f.toString())
    ...
    h.throttle = function(a, b, c, d) {
        ...
        return function() {
            ...
            f || function() {
                ...
                l && (a.apply(c || g, l),
                l = null,
                f = h.setTimeout(arguments.callee, b, d))
            }()
        }
    }
    ;
    var Va = I.inherit({
        ...
        append: function(a, b) {
            ...
            this._flushTID || (this._flushTID = h.defer(this._flush, this.flushTimeout, this, [b], "DataBuffer._flush")))
        },
        activate: function() {
    ...
    h.async = function(a, b, c) {
        if (m.postMessage) {
            ...
            var f = function(c) {
                ...
                g === d && (c.stopPropagation && c.stopPropagation(),
                a.call(b),
                y.un(m, "message", f, null, {
                    passive: !1
                }))
            };
    ...
    Ca.stringify = function(a, b) {
        ...
        if (d.lastOrdering !== A)
            for (n = 1; n <= b.lastOrdering.length; n++)
                f[b.lastOrdering[n - 1]] = l + n;
        if (d.firstOrdering !== A)
            for (n = 0; n < b.firstOrdering.length; n++)
                f[b.firstOrdering[n]] = n;
        for (g in a)
      ...
      , Wa = wa.inherit({
        ...
        request: function(a, b, c, d) {
            ...
            if (/[^a-z0-9.:-]/.test(M.host) && m.opera && "function" === typeof m.opera.version) {
                ...
                if ("string" === typeof g && "12" === g.split(".")[0])
                    return c.call(d, !1)
            }
            if (m.XMLHttpRequest) {
    ...
    var Yb = wa.inherit({
        ...
        index: 1,
        request: function(a, b, c, d) {
            "function" === typeof navigator.sendBeacon && !x.isAndroidWebView() && navigator.onLine ? (b = this._splitParams(b),
            b.get["force-urlencoded"] = 1,
            c.call(d, navigator.sendBeacon(this._buildUrl(a, b.get), Ca.stringify(b.post)))) : c.call(d, !1)
        }
    });
    ...
    h.toJSON = function(a) {
        ...
        case Array:
            ...
            for (b = a.length; d < b; d++)
                c[c.length] = h.toJSON(a[d]);
            return "[" + c.join(",") + "]";
        case Object:
            c = [];
            for (d in a)
                a.hasOwnProperty(d) && a[d] !== A && (c[c.length] = h.toJSON(d) + ":" + h.toJSON(a[d]));
            return "{" + c.join(",") + "}";
        default:
    ...
    var ea = I.inherit({
        ...
        getStorageId: function() {
            var a = this.get("lsid");
            a || (a = Math.round(Math.random() * v.getMs()),
            this.set("lsid", a));
            return a
        },
    ...
    var na = {
        ...
        encode: function(a, b) {
            ...
            case 2:
                n = (a[l] << 10) + (a[l + 1] << 2),
                h.mergeArrays(f, [c[n >> 12 & 63], c[n >> 6 & 63], c[n & 63], c[64]])
            }
            return f.join("")
        },
        decode: function(a, b) {
            for (var c = na.abc + (b ? na.tailSafe : na.tail), d = 0, f = "", l, g, n, h, t; a.length % 4; )
                a += "\x3d";
            do {
                ...
                g = n >> 8 & 255;
                n &= 255;
                f = 64 == h ? f + String.fromCharCode(l) : 64 == t ? f + String.fromCharCode(l, g) : f + String.fromCharCode(l, g, n)
            } while (d < a.length);return f
        }
    }
      , Qa = {
        encode: function(a) {
            ...
            for (c = a.length; d < c; d++) {
                ...
                128 > f ? b.push(f) : (127 < f && 2048 > f ? b.push(f >> 6 | 192) : (b.push(f >> 12 | 224),
                b.push(f >> 6 & 63 | 128)),
                b.push(f & 63 | 128))
            }
            return b
    ...
    var Ea = {
        ...
        initPU: function(a, b) {
            ...
            var d = x.isFF(68);
            this.globalConfig = b;
            b.get("pu") !== A || this.checkVersion() && !d || (b.setSafe("pu", null),
            ...
            m.opener ? (d = h.setTimeout(function() {
                c.genPu(b)
            }, 200, "pu"),
            a.sendToIframe(m.opener, {
                type: "gpu-get"
        ...
        onicecandidate: F(function(a) {
            ...
            c && 0 < c.length && (this.pp = h.fnv32a(c[1]),
        ...
        initPP: F(function(a) {
            ...
            this.globalConfig = a;
            if (m.navigator.onLine && b && a.get("pp") == A && (this.globalConfig.setSafe("pp", null),
        ...
        onMessage: function(a) {
            ...
            w.removeNode(this.frame),
            this._storage.set(this.key, this.zz),
            y.un(m, "message", this.onMessage, this, {
                passive: !1
            }),
      ...
      , U = Xb.inherit({
        ...
        _sendSavedRequest: function(a, b, c, d, f) {
            var l = this.globalConfig.get("firstReqStatus")
              , g = b.forceNoRedirect;
            if ("process" == l)
                this.globalConfig.set("firstReqCallbacks", h.mergeArrays(this.globalConfig.get("firstReqCallbacks") || [], [[this, arguments]]));
            else {
    ...
    U.initCookie = function(a) {
        ...
        if (!c)
            ...
            b.create(a, c, 525600),
            b.create("d", g, 525600);
        else if (!l || 15768E3 < g - parseInt(l))
            b.create(a, c, 525600),
            b.create("d", g, 525600);
        U._storage.set(a, c);
        U._userID = c;
    ...
    var $b = /(\?|&)turbo_uid=([\w\d]+)($|&)/
      ...
      , bc = function(a, b) {
        var c = b.search.match($b)
          ...
          , f = a.read("turbo_uid");
        c && 2 <= c.length ? (d = c[2],
        a.create("turbo_uid", d, 86400)) : f && (d = f);
        return d
    };
    ...
    ;
    w.getBody = function() {
        for (var a = u.getElementsByTagName("body"); 0 < a.length; )
            return a[0]
    }
    ;
        ...
        if ("undefined" != typeof a.plugins && "object" == typeof a.plugins["Shockwave Flash"]) {
            ...
            if ((b = b.description) || c)
                ...
                "undefined" == typeof a || !a["application/x-shockwave-flash"] || a["application/x-shockwave-flash"].enabledPlugin)
                    c ? x._flashVersion = c : b && (x._flashVersion = b.replace(/([a-zA-Z]|\s)+/, "").replace(/(\s+r|\s+b[0-9]+)/, "."))
        } else if ("undefined" != typeof m.ActiveXObject)
            try {
                if (c = new ActiveXObject("ShockwaveFlash.ShockwaveFlash"),
                b = c.GetVariable("$version"))
                    x._flashVersion = b.split(" ")[1].replace(/,/g, ".").replace(/[^.\d]/g, "")
            } catch (d) {}
    ...
    x.getFingerPrint = h.memorize(function() {
        ...
        if (navigator.mimeTypes && navigator.mimeTypes.length)
            for (b = 0; b < navigator.mimeTypes.length; b++)
                ...
                h.mergeArrays(a, [c.type, c.description, c.suffixes]);
    ...
    x.isDesktop = function(a) {
        var b = a.get("bt", {});
        a.get("bt") === A && (b.p = navigator.getBattery ? navigator.getBattery() : null,
        a.set("bt", b),
    ...
    x.isSelenium = h.memorize(function() {
        ...
        for (c = 0; c < f.length; c++)
            if (d && d[f[c]])
                return !0;
        if (m.external && m.external.toString && 0 <= m.external.toString().indexOf("Sequentum"))
            return !0;
        if (d.documentElement && d.documentElement.getAttribute)
            for (c = 0; c < b.length; c++)
                if (d.documentElement.getAttribute(b[c]))
                    return !0;
        return !1
    });
    y.ready = function(a) {
    ...
    var yb = {
        ...
        _send: function() {
            ...
            y.ready(function() {
                ...
                x.isSafari() && (b.style.position = "absolute",
                b.style.visibility = "hidden",
                b.style.width = "0px",
                b.style.height = "0px",
                w.getRootElement().appendChild(b))
            })
        },
        _saveReq: function(a) {
            this._value = a = a ? "1" : "2";
    ...
    Qa.decode = function(a) {
        for (var b = "", c = 0, d, f, l; c < a.length; )
            d = a.charCodeAt(c),
            128 > d ? (b += String.fromCharCode(d),
            c++) : 191 < d && 224 > d ? (f = a.charCodeAt(c + 1),
            b += String.fromCharCode((d & 31) << 6 | f & 63),
            c += 2) : (f = a.charCodeAt(c + 1),
            l = a.charCodeAt(c + 2),
            b += String.fromCharCode((d & 15) << 12 | (f & 63) << 6 | l & 63),
            c += 3);
        return b
    }
    ;
    ...
    var Ra = U.inherit({
        ...
        paramsQueue: {
            ...
            mixin: function(a) {
                var b = {};
                this.paramsQueue.length && (b = h.reduce(this._reduce(h.keys(a)), {}, this.paramsQueue),
                this.paramsQueue = h.filter(this._filter, this.paramsQueue));
                return h.mixin({}, a, b)
            }
        },
        ...
        _hitExt: function(a, b) {
            ...
            if (!h.isMetrikaPlayer()) {
                ...
                var m = {};
                a.nohit && c("nohit", 1);
                n.ar && !n.onlyData && (t = null === t || "" === t ? "" : this._prepareHitUrl(t),
                p = this._prepareHitUrl(a.url));
                c("forceNoRedirect", a.forceNoRedirect);
                c("page-ref", h.trim(t, lb));
                c("page-url", h.trim(p, lb));
                h.is4Bytes(a.title) && c("charset", "utf-8");
                -1 != L().hostname.search(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/) ? c("ut", kb) : "undefined" != typeof n.ut && c("ut", h.trim(n.ut, cc));
                c("exp", a.experiments);
                (f = a.vParams) && this.counter && f.__ym && (h.isNumber(f.__ym.turbo_page) && (this.counter.tp = f.__ym.turbo_page),
                h.isNumber(f.__ym.turbo_page_id) && (this.counter.tpid = f.__ym.turbo_page_id));
                (!f || h.isObject(f) && !f.__ym && !f.__ymu) && this.paramsQueue.length() && h.inArray(["go", "hit", "pa"], b) && (f = this.paramsQueue.mixin(f));
                f && (p = h.toJSON(f),
                this.trimParams && p.length > dc ? l = !0 : 7E5 < p ? h.warning("Too big params") : c("site-info", p));
                n.saveRef && (Za.lastReferrer = t);
                g = function(a, b) {
                    var c = {};
        ...
        _getTechInfo: function(a, b, c, d, f, l, g, n, r, t) {
            ...
            x.isIframe() && (p("ifr", "1"),
            p("sti", x.isSameOriginTopFrame() ? "1" : "0"));
            ...
            f.isEnabled() && (c = f.getStorageId(),
            d = f.get("reqNum"),
            t || (d ? d++ : d = 1),
            f.set("reqNum", d),
            f.get("reqNum") == d ? (p("ls", c),
            p("rqn", d)) : (f.remove("reqNum"),
            f.clearStorageId(),
            1 < d && (p("ls", c),
            p("rqn", 0))));
            p("rn", h.random());
            ...
            r._firstPaint || t || (r._firstPaint = Vb(),
            p("fp", r._firstPaint));
            if (n) {
                g = C.get("winNameNum");
                if (!g) {
                    if (g = +m.name || Math.round(65535 * Math.random()))
                        0 > g && (g *= -1),
                        g %= 65535;
    ...
    w.getDocumentHTML = function() {
        ...
        if (c)
            ...
            for (d = 0; d < c.length; d++)
                (f = c[d]) && (l += " " + f.name + '\x3d"' + (f.value || "") + '"');
            b = "\x3chtml" + l + "\x3e" + b.innerHTML + "\x3c/html\x3e"
        }
        if (c = u.doctype)
            a = c.publicId ? ' PUBLIC "' + c.publicId + '"' : "",
            l = c.systemId ? ' "' + c.systemId + '"' : "",
            a = "\x3c!DOCTYPE " + c.name + a + l + "\x3e\n";
        return a + b
    }
    ;
    w.getElementParent = function(a) {
        if (!a || a == u.documentElement)
            return null;
        if (a == w.getBody())
    ...
    w.getElementXY = function(a) {
        var b;
        if (!a || !a.ownerDocument || "PARAM" == a.tagName || a == w.getBody() || a == u.documentElement)
            return [0, 0];
        if (a.getBoundingClientRect) {
    ...
    w.getElementSize = function(a) {
        var b;
        return a == w.getBody() || a == u.documentElement ? w.getDocumentSize() : (b = a.getBoundingClientRect && a.getBoundingClientRect()) ? [b.width, b.height] : [a.offsetWidth, a.offsetHeight]
    }
    ;
    ...
    w.getElementsByClassName = function(a, b) {
        ...
        for (c = 0; c < d.length; c++)
            w.classNameExists(d[c], a) && f.push(d[c]);
        return f
    }
    ;
    try {
        if (wb) {
            ...
            , function(a, b) {
                ...
                var d = function(a) {
                    ...
                    b.prototype.Y = function(a) {
                        ...
                        return c ? (0 === (b = a.getParameter(c.MAX_TEXTURE_MAX_ANISOTROPY_EXT)) && (b = 2),
                        b) : null
                    }
                    ,
                    b.prototype.u = function() {
                        ...
                        try {
                            ...
                            q && (b.push("webgl unmasked vendor:" + a.getParameter(q.UNMASKED_VENDOR_WEBGL)),
                            b.push("webgl unmasked renderer:" + a.getParameter(q.UNMASKED_RENDERER_WEBGL)))
                        } catch (k) {}
                    ...
                    return a.prototype.U = function() {
                        return this.c = this.canvas.getContext(this.P),
            ...
            , function(a, b) {
                ...
                a = function() {
                    ...
                    return a.prototype.b = function() {
                        ...
                        if (!(b && b.getContext && b.getContext("2d")))
                            return "";
                        var c = [];
                        (b = b.getContext("2d")).font = "30px " + this.o;
                        for (var g = b.measureText(this.o).width, h = 0, r = a.length; h < r; h++)
                            b.font = "30px " + a[h],
                            c.push(b.measureText(this.o).width === g);
                        return c.join("x")
                    }
                    ,
                    a
            ...
            , function(a, b) {
                ...
                a = function() {
                    function a() {}
                    return a.prototype.b = function() {
                        if (!(c = m.speechSynthesis))
                            return "";
                        for (var a, b = [], c = c.getVoices(), g = 0; g < c.length; g++)
                            a = c[g],
                            b.push("" + a.name + a.lang + a.localService + a.voiceURI + a["default"]);
                        return b.join("")
                    }
                    ,
                    a
                ...
                a = function() {
                    ...
                    return a.prototype.b = function() {
                        return d.A(navigator.plugins).sort(function(a, b) {
                            ...
                            return [a.name, a.description, d.A(a).map(function(a) {
            ...
            , function(a, b) {
                ...
                a = function() {
                    ...
                    return a.prototype.b = function() {
                        ...
                        return [a("prefers-reduced-motion"), a("prefers-reduced-transparency"), a("prefers-color-scheme: dark"), a("prefers-color-scheme: light"), a("pointer: none"), a("pointer: coarse"), a("pointer: fine"), a("any-pointer: none"), a("any-pointer: coarse"), a("any-pointer: fine"), a("scan: interlace"), a("scan: progressive"), a("color-gamut: srgb"), a("color-gamut: p3"), a("color-gamut: rec2020"), a("update: fast"), a("update: slow"), a("update: none"), a("grid: 0"), a("grid: 1"), a("hover: hover"), a("inverted-colors: inverted"), a("inverted-colors: none")].join("x")
                    }
                    ,
                    a
                }();
            ...
            , function(a, b) {
                ...
                a = function() {
                    ...
                    return a.prototype.b = function() {
                        var a = m.navigator;
                        return [a.appName, a.vendor, a.i, a.s, a.maxTouchPoints, a.appVersion, a.productSub, a.appCodeName, a.vendorSub, a.getGamepads && a.getGamepads().length].join("x")
                    }
                    ,
                    a
                }();
                ...
                a = function() {
                    ...
                    a.prototype.b = function() {
                        for (var a = u.createElement("video"), b = [], c = 1; c < this.types.length; c++) {
                            ...
                            for (var g = 1; g < this.v.length; g++)
                                b.push(a.canPlayType(this.w(this.types[c] + '; codecs\x3d"' + this.v[g] + '"')))
                        }
                        return b.join("")
                    }
                    ,
            ...
            , function(a, b) {
                ...
                b.hash = function(a, b) {
                    ...
                    var n = (a = a || "").length % 16
                      ...
                      , q = [0, b];
                    b = [0, b];
                    for (var k, e, D = [2277735313, 289559509], H = [1291169091, 658871167], z = 0; z < r; z += 16)
                        k = [255 & a.charCodeAt(z + 4) | (255 & a.charCodeAt(z + 5)) << 8 | (255 & a.charCodeAt(z + 6)) << 16 | (255 & a.charCodeAt(z + 7)) << 24, 255 & a.charCodeAt(z) | (255 & a.charCodeAt(z + 1)) << 8 | (255 & a.charCodeAt(z + 2)) << 16 | (255 & a.charCodeAt(z + 3)) << 24],
                        e = [255 & a.charCodeAt(z + 12) | (255 & a.charCodeAt(z + 13)) << 8 | (255 & a.charCodeAt(z + 14)) << 16 | (255 & a.charCodeAt(z + 15)) << 24, 255 & a.charCodeAt(z + 8) | (255 & a.charCodeAt(z + 9)) << 8 | (255 & a.charCodeAt(z + 10)) << 16 | (255 & a.charCodeAt(z + 11)) << 24],
                        k = f(k = c(k, D), 31),
                        q = d(q = f(q = g(q, c(k, H)), 27), b),
                        q = d(c(q, [0, 5]), [0, 1390208809]),
                        e = f(e = c(e, H), 33),
                        b = d(b = f(b = g(b, c(e, D)), 31), q),
                    ...
                    case 9:
                        e = c(e = g(e, [0, a.charCodeAt(z + 8)]), H),
                        b = g(b, c(f(e, 33), D));
                    case 8:
                    ...
                    case 1:
                        k = c(k = g(k, [0, a.charCodeAt(z)]), D),
                        q = g(q, c(f(k, 31), H))
                    }
                    return q = d(q = g(q, [0, a.length]), b = g(b, [0, a.length])),
                    b = d(b, q),
                    q = d(q = h(q), b = h(b)),
                    b = d(b, q),
                    ("00000000" + (q[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (q[1] >>> 0).toString(16)).slice(-8) + ("00000000" + (b[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (b[1] >>> 0).toString(16)).slice(-8)
                }
            }
            ]);
            jb = jb["default"]
    ...
    var mb = {
        ...
        addAsyncItem: function(a, b, c, d, f) {
            ...
            l.flushAsync(!0)) : v.getMs() - this.rest >= this.restTime && !this.timeout ? (this.rest = v.getMs(),
            l.flushAsync()) : this.timeout || (this.timeout = h.setTimeout(function() {
                l.rest = v.getMs();
                l.flushAsync();
                l.timeout = !1
            }, this.restTime))
        ...
        callByTimeout: function(a, b) {
            for (var c = v.getMs(), d = 0, f, l = (b || 0) + 1, g = 0, n = this; this.asyncBuffer.length; )
                if (f = this.asyncBuffer.shift(),
                g += 1,
                !f.isExecuted && (F(function() {
      ...
      , $a = Va.inherit({
        ...
        addData: function(a, b, c, d, f) {
            ...
            if (!this.totalSendLimit || this._totalSendedSize < this.totalSendLimit)
                if (this._v = c,
                this.wrappers.length && h.arrayEvery(this.wrappers, function(c) {
                ...
                f)
                    ...
                    if (f > this.maxBufferSize)
                        ...
                        d = Math.ceil(c.length / r); l < c.length; )
                            n.partNum = g,
                            n.end = g === d,
                            n.data = c.slice(l, l += r),
                            g++,
                            this._getSize(n.data),
                            this.append([n], !0);
                    else
                        n.data = c,
                        this.append([n], d);
    ...
    try {
        J = function(a) {
            ...
            function d(a, b, c) {
                for (var d = Object.keys(b), f = 0; f < d.length; ++f)
                    void 0 !== a[d[f]] && c || (a[d[f]] = b[d[f]]);
                return a
            }
            function f(a) {
                function b(a, c) {
        ...
        , function(a, b, c) {
            ...
            a.exports = f;
            var r, t = c(0), p = t.LongBits, m = t.utf8, q, k = "undefined" != typeof Uint8Array ? function(a) {
            ...
            f.prototype.uint32 = (q = 4294967295,
            function() {
        ...
        , function(a, b, c) {
            ...
            g.prototype.reset = function() {
                ...
                this.states = this.states.next) : (this.head = this.tail = new d(f,0,0),
                this.len = 0);
                return this
            }
            ;
            ...
            g.prototype.finish = function() {
                for (var a = this.head.next, b = this.constructor.alloc(this.len), c = 0; a; )
                    a.fn(a.val, b, c),
                    c += a.len,
                    a = a.next;
                return b
        ...
        , function(a, b, c) {
            ...
            d.from = function(a) {
                if ("number" == typeof a)
                    return d.fromNumber(a);
                if (f.isString(a)) {
                    if (!f.Long)
                        return d.fromNumber(parseInt(a, 10));
        ...
        , function(a, b, c) {
            b.length = function(a) {
                for (var b = 0, c, d = 0; d < a.length; ++d)
                    c = a.charCodeAt(d),
                    128 > c ? b += 1 : 2048 > c ? b += 2 : 55296 == (64512 & c) && 56320 == (64512 & a.charCodeAt(d + 1)) ? (++d,
                    b += 4) : b += 3;
                return b
            }
            ;
            b.read = function(a, b, c) {
                if (1 > c - b)
                    return "";
                for (var d, f = null, h = [], l = 0; b < c; )
                    d = a[b++],
                    128 > d ? h[l++] = d : 191 < d && 224 > d ? h[l++] = (31 & d) << 6 | 63 & a[b++] : 239 < d && 365 > d ? (d = ((7 & d) << 18 | (63 & a[b++]) << 12 | (63 & a[b++]) << 6 | 63 & a[b++]) - 65536,
                    h[l++] = 55296 + (d >> 10),
                    h[l++] = 56320 + (1023 & d)) : h[l++] = (15 & d) << 12 | (63 & a[b++]) << 6 | 63 & a[b++],
                    8191 < l && ((f || (f = [])).push(String.fromCharCode.apply(String, h)),
                    l = 0);
            ...
            b.write = function(a, b, c) {
                for (var d, f, h = c, l = 0; l < a.length; ++l)
                    d = a.charCodeAt(l),
                    128 > d ? b[c++] = d : (2048 > d ? b[c++] = d >> 6 | 192 : (55296 == (64512 & d) && 56320 == (64512 & (f = a.charCodeAt(l + 1))) ? (d = 65536 + ((1023 & d) << 10) + (1023 & f),
                    ++l,
                    b[c++] = d >> 18 | 240,
                    b[c++] = d >> 12 & 63 | 128) : b[c++] = d >> 12 | 224,
                    b[c++] = d >> 6 & 63 | 128),
                    b[c++] = 63 & d | 128);
                return c - h
            }
            ...
            function d(a) {
                "undefined" != typeof Float32Array ? function() {
                    ...
                    function b(a, b, c, e) {
                        ...
                        d && (b = -b);
                        if (0 === b)
                            a(0 < 1 / b ? 0 : 2147483648, c, e);
                        else if (isNaN(b))
                            a(2143289344, c, e);
                        else if (3.4028234663852886e+38 < b)
                            a((d << 31 | 2139095040) >>> 0, c, e);
                        else if (1.1754943508222875e-38 > b)
                            a((d << 31 | Math.round(b / 1.401298464324817e-45)) >>> 0, c, e);
                        else {
                ...
                "undefined" != typeof Float64Array ? function() {
                    ...
                    function b(a, b, c, e, d, f) {
                        ...
                        if (0 === e)
                            a(0, d, f + b),
                            a(0 < 1 / e ? 0 : 2147483648, d, f + c);
                        else if (isNaN(e))
                            a(0, d, f + b),
                            a(2146959360, d, f + c);
                        else if (1.7976931348623157e+308 < e)
                            a(0, d, f + b),
                            a((k << 31 | 2146435072) >>> 0, d, f + c);
                        else if (2.2250738585072014e-308 > e)
                            e /= 5e-324,
                            a(e >>> 0, d, f + b),
                            a((k << 31 | e / 4294967296) >>> 0, d, f + c);
                        else {
        ...
        , function(a, b, c) {
            ...
            d.prototype.off = function(a, b) {
                if (void 0 === a)
                    ...
                    for (var c = this._listeners[a], d = 0; d < c.length; )
                        c[d].fn === b ? c.splice(d, 1) : ++d;
                return this
            }
            ;
        ...
        , function(a, b, c) {
            ...
            var d = Array(64)
              , f = Array(123);
            for (a = 0; 64 > a; )
                f[d[a] = 26 > a ? a + 65 : 52 > a ? a + 71 : 62 > a ? a - 4 : a - 59 | 43] = a++;
            b.encode = function(a, b, c) {
                for (var f, g = null, h = [], l = 0, q = 0; b < c; ) {
                    ...
                    8191 < l && ((g || (g = [])).push(String.fromCharCode.apply(String, h)),
                    l = 0)
                }
                q && (h[l++] = d[f],
                h[l++] = 61,
                1 === q && (h[l++] = 61));
                return g ? (l && g.push(String.fromCharCode.apply(String, h.slice(0, l))),
                g.join("")) : String.fromCharCode.apply(String, h.slice(0, l))
            }
            ;
        ...
        , function(a, b, c) {
            a.exports = function(a, b) {
                for (var c = Array(arguments.length - 1), d = 0, f = 2, h = !0; f < arguments.length; )
                    c[d++] = arguments[f++];
                            ...
                            a.proto = function() {
                                    ...
                                    a.encode = function(a, b) {
                                        ...
                                        if (null != a.buffer && a.buffer.length)
                                            for (var c = 0; c < a.buffer.length; ++c)
                                                g.ru.yandex.metrika.wv2.proto.Buffer.encode(a.buffer[c], b.uint32(10).fork()).ldelim();
                                        return b
                                    }
                                    ;
                                    ...
                                    a.encode = function(a, b) {
                                        ...
                                        if (null != a.content && a.content.length)
                                            for (var c = 0; c < a.content.length; ++c)
                                                g.ru.yandex.metrika.wv2.proto.Page.Content.encode(a.content[c], b.uint32(18).fork()).ldelim();
                                    ...
                                    a.Scroll = function() {
                                        ...
                                        a.encode = function(a, b) {
                                            ...
                                            if (null != a.scroll && a.scroll.length) {
                                                b.uint32(18).fork();
                                                for (var c = 0; c < a.scroll.length; ++c)
                                                    b.int32(a.scroll[c]);
                                                b.ldelim()
                                            }
                                            return b
                                        ...
                                        a.decode = function(a, b) {
                                            ...
                                            for (var c = void 0 === b ? a.len : a.pos + b, e = new g.ru.yandex.metrika.wv2.proto.Page.Scroll; a.pos < c; ) {
                                                ...
                                                case 2:
                                                    ...
                                                    if (2 == (7 & k))
                                                        for (k = a.uint32() + a.pos; a.pos < k; )
                                                            e.scroll.push(a.int32());
                                                    else
                                                        e.scroll.push(a.int32());
                                                    break;
                                                default:
                                    ...
                                    a.Meta = function() {
                                        ...
                                        a.encode = function(a, b) {
                                            ...
                                            if (null != a.initialScroll && a.initialScroll.length)
                                                for (var c = 0; c < a.initialScroll.length; ++c)
                                                    g.ru.yandex.metrika.wv2.proto.Page.Scroll.encode(a.initialScroll[c], b.uint32(90).fork()).ldelim();
                                            return b
                                        }
                                        ;
                                        a.decode = function(a, b) {
                                    ...
                                    a.Content = function() {
                                        ...
                                        a.encode = function(a, b) {
                                            ...
                                            if (null != a.attributes && Object.hasOwnProperty.call(a, "attributes"))
                                                for (var c = Object.keys(a.attributes), d = 0; d < c.length; ++d)
                                                    b.uint32(26).fork().uint32(10).string(c[d]).uint32(18).string(a.attributes[c[d]]).ldelim();
                                        ...
                                        a.decode = function(a, b) {
                                            a instanceof d || (a = d.create(a));
                                            for (var c, e = void 0 === b ? a.len : a.pos + b, k = new g.ru.yandex.metrika.wv2.proto.Page.Content; a.pos < e; )
                                                switch (c = a.uint32(),
                                                c >>> 3) {
                                                case 1:
                                                    k.id = a.int32();
                                ...
                                a.Mutation = function() {
                                    ...
                                    a.Add = function() {
                                        ...
                                        a.encode = function(a, b) {
                                            ...
                                            if (null != a.at && Object.hasOwnProperty.call(a, "at"))
                                                for (var c = Object.keys(a.at), d = 0; d < c.length; ++d)
                                                    b.uint32(50).fork().uint32(10).string(c[d]).uint32(18).string(a.at[c[d]]).ldelim();
                                        ...
                                        a.decode = function(a, b) {
                                            a instanceof d || (a = d.create(a));
                                            for (var c, e = void 0 === b ? a.len : a.pos + b, k = new g.ru.yandex.metrika.wv2.proto.Mutation.Add; a.pos < e; )
                                                switch (c = a.uint32(),
                                                c >>> 3) {
                                                case 1:
                                                    k.id = a.int32();
                                    ...
                                    a.AttributeChange = function() {
                                        ...
                                        a.encode = function(a, b) {
                                            ...
                                            if (null != a.at && Object.hasOwnProperty.call(a, "at"))
                                                for (var c = Object.keys(a.at), d = 0; d < c.length; ++d)
                                                    b.uint32(18).fork().uint32(10).string(c[d]),
                                        ...
                                        a.decode = function(a, b) {
                                            a instanceof d || (a = d.create(a));
                                            for (var c, e = void 0 === b ? a.len : a.pos + b, k = new g.ru.yandex.metrika.wv2.proto.Mutation.AttributeChange; a.pos < e; )
                                                switch (c = a.uint32(),
                                                c >>> 3) {
                                                case 1:
                                                    k.id = a.int32();
                                        ...
                                        a.encode = function(a, b) {
                                            ...
                                            if (null != a.a && a.a.length)
                                                for (var c = 0; c < a.a.length; ++c)
                                                    g.ru.yandex.metrika.wv2.proto.Mutation.Delete.encode(a.a[c], b.uint32(10).fork()).ldelim();
                                            if (null != a.b && a.b.length)
                                                for (c = 0; c < a.b.length; ++c)
                                                    g.ru.yandex.metrika.wv2.proto.Mutation.Add.encode(a.b[c], b.uint32(18).fork()).ldelim();
                                            if (null != a.c && a.c.length)
                                                for (c = 0; c < a.c.length; ++c)
                                                    g.ru.yandex.metrika.wv2.proto.Mutation.AttributeChange.encode(a.c[c], b.uint32(26).fork()).ldelim();
                                            if (null != a.d && a.d.length)
                                                for (c = 0; c < a.d.length; ++c)
                                                    g.ru.yandex.metrika.wv2.proto.Mutation.TextChange.encode(a.d[c], b.uint32(34).fork()).ldelim();
                                            return b
                                        }
                                        ;
                                        a.decode = function(a, b) {
                                        ...
                                        a.encode = function(a, b) {
                                            ...
                                            if (null != a.changes && a.changes.length)
                                                for (var c = 0; c < a.changes.length; ++c)
                                                    g.ru.yandex.metrika.wv2.proto.Mutation.Changes.encode(a.changes[c], b.uint32(18).fork()).ldelim();
                                            return b
                                        }
                                        ;
                                        a.decode = function(a, b) {
                                ...
                                a.Event = function() {
                                    ...
                                    a.encode = function(a, b) {
                                        ...
                                        null != a.windowEvent && Object.hasOwnProperty.call(a, "windowEvent") && g.ru.yandex.metrika.wv2.proto.WindowEvent.encode(a.windowEvent, b.uint32(50).fork()).ldelim();
                                    ...
                                    a.decode = function(a, b) {
                                        ...
                                        for (var c = void 0 === b ? a.len : a.pos + b, e = new g.ru.yandex.metrika.wv2.proto.Event; a.pos < c; ) {
                                            ...
                                            case 7:
                                                ...
                                                break;
                                            case 8:
                                                e.changeEvent = g.ru.yandex.metrika.wv2.proto.ChangeEvent.decode(a, a.uint32());
                                                break;
                                            case 9:
                                    ...
                                    a.encode = function(a, b) {
                                        ...
                                        if (null != a.touches && a.touches.length)
                                            for (var c = 0; c < a.touches.length; ++c)
                                                g.ru.yandex.metrika.wv2.proto.TouchEvent.SubMeta.encode(a.touches[c], b.uint32(10).fork()).ldelim();
                                        return b
                                    }
                                    ;
                                    a.decode = function(a, b) {
                                    ...
                                    a.encode = function(a, b) {
                                        ...
                                        if (null != a.keystrokes && a.keystrokes.length)
                                            for (var c = 0; c < a.keystrokes.length; ++c)
                                                g.ru.yandex.metrika.wv2.proto.KeystrokesEvent.KeystrokeEvent.encode(a.keystrokes[c], b.uint32(10).fork()).ldelim();
                                        return b
                                    }
                                    ;
                                    a.decode = function(a, b) {
                                    ...
                                    a.encode = function(a, b) {
                                        ...
                                        if (null != a.articleMeta && a.articleMeta.length)
                                            for (var c = 0; c < a.articleMeta.length; ++c)
                                                g.ru.yandex.metrika.wv2.proto.ArticleMeta.encode(a.articleMeta[c], b.uint32(10).fork()).ldelim();
                                    ...
                                    a.encode = function(a, b) {
                                        ...
                                        if (null != a.authors && a.authors.length)
                                            for (var c = 0; c < a.authors.length; ++c)
                                                g.ru.yandex.metrika.wv2.proto.ArticleAuthor.encode(a.authors[c], b.uint32(34).fork()).ldelim();
                                        if (null != a.topics && a.topics.length)
                                            for (c = 0; c < a.topics.length; ++c)
                                                g.ru.yandex.metrika.wv2.proto.ArticleTopic.encode(a.topics[c], b.uint32(42).fork()).ldelim();
                                        ...
                                        if (null != a.rubric && a.rubric.length)
                                            for (c = 0; c < a.rubric.length; ++c)
                                                g.ru.yandex.metrika.wv2.proto.ArticleRubric.encode(a.rubric[c], b.uint32(66).fork()).ldelim();
          ...
          , hc = {
            ...
            eventSerialize: function(a) {
                ...
                for (c = 0; c < b.length; c++)
                    var d = b[c];
                if (d)
                    return d.repeated ? (c = new d.type,
                    c[d.repeated] = a.meta[d.repeated] || a.meta) : c = new d.type(this.nullToStr(a.meta)),
                    b = new J.Event({
                        type: J.EventType[d.eventName],
                        target: a.target,
                        frameId: a.frameId
                    }),
                    b[this.uncapitalize(d.typeStr)] = c,
                    b
            },
            ...
            toTransport: function(a, b, c, d) {
                ...
                if (c)
                    ...
                    return J[f].encode(this.nullToStr(a)).finish()
            },
            fromTrasport: function(a, b) {
                if ("number" == typeof a[0])
                    return J[b || "BufferWrapper"].decode(a)
            },
            serialize: function(a, b, c) {
                ...
                if (h)
                    d[a] = h.call(this, b),
                    f = new J.Wrapper(d);
                else if (c && J.Wrapper.prototype[a] !== A)
                    f[a] = b;
                else
    ...
    var Bb = Va.inherit({
        ...
        addData: function(a, b, c, d, f) {
            ...
            if (!this.totalSendLimit || this._totalSendedSize < this.totalSendLimit)
                ...
                f) {
                    ...
                    this._data && 0 == this._data.buffer.length && (this.startBufferTime = v.getSeconds()),
                    this.updateStamp(b, l),
                    g = this.serializer.serialize(a, b),
                    d ? (c = this.serializer.toTransport(g, "Wrapper"),
                    this.sendEncoded(c, l, g, !0, {
                        id: a,
                        data: b
        ...
        onFlush: function(a, b, c, d) {
            ...
            a.buffer && a.buffer.length && (d ? this._sender.sendPacket(this.serializer.toTransport(a), b.url, b.hitId, c, b.timezone, b.timestamp, this.startBufferTime) : this.serializer.toTransport(a, "BufferWrapper", function(a) {
    ...
    S.log = F(function() {
        ...
        m.console && console.log && this._check() && (S.enabled = !0,
    ...
    w.closest = function(a, b) {
        var c;
        if (!(m && m.Element && m.Element.prototype))
            return null;
        if (m.Element.prototype.closest && h.isNativeFunction(m.Element.prototype.closest, "closest"))
            return a.closest(b);
    ...
    var E = {
      ...
      , bb = I.inherit({
        ...
        _getTitleFromContent: function(a) {
            var b, c;
            for (b = 1; 5 >= b; b++)
                if (c = E.getVal(E.selectOne(a, "h" + b)))
                    return c;
            return null
        },
        _getType: function() {
        ...
        contentSizeWarning: function(a) {
            -1 === h.arrayIndexOf(this.alreadyWarned, a.id) && (S.log("Warning: content has only " + a.chars + " chars.Required " + ya[a.type], a),
            this.alreadyWarned.push(a.id))
        },
                ...
                if (d = this._getContentData({
                    ...
                    h.map(function(a) {
                        a && (a.chars <= ya[a.type] ? l.contentSizeWarning(a) : (a = h.mixin({
                            sended: !1,
                            involvedTime: 0
                        }, a)) && !h.inArray(c, a.id) && (a.index = b.push(a),
                        c.push(a.id)))
                    }, d);
            return b
        }
    ...
    var ob = bb.inherit({
        ...
        fields: {
            ...
            pageTitle: function(a) {
                ...
                "" === b && ((d = E.selectPropOne(c, "name")) || (d = E.selectPropOne(c, "itemReviewed")),
                d && (b += E.getVal(d)));
        ...
        _getContentData: function(a) {
            return a.element && a.element.innerText && a.element.innerText.length ? ob.superclass._getContentData.call(this, a) : null
        },
      ...
      , cb = bb.inherit({
        ...
        fields: {
            ...
            rubric: function(a) {
                ...
                h.isArray(c)) ? h.filter(Boolean, h.map(function(a) {
        ...
        _extractArrayField: function(a, b, c) {
            if (!a || !a[b])
                return [];
        ...
        _getContentData: function(a) {
            ...
            if (!a.data && (a.data = R.parse(b.innerText),
            !a.data || !/schema\.org/.test(a.data["@context"])))
                return null;
            if (h.isArray(a.data["@graph"]))
                return h.map(function(a) {
                    if (!h.inArray(c.schemaEntities["schema.org"], a["@type"]))
                        return null;
                    a = {
                        element: b,
                        data: a,
            ...
            if (f)
                return a = h.reduce(function(a, b) {
                    var c = f[b] || [];
            ...
            if (!h.inArray(this.schemaEntities["schema.org"], a.data["@type"]))
                return null;
      ...
      , Cb = bb.inherit({
        ...
        _findContentDescriptionNodes: function() {
            var a = [u.head]
              , b = E.select(u.body, 'meta[property\x3d"og:type"]');
        ...
        _getEntityData: function(a) {
            ...
            if (d && d.length)
                h.map(function(a) {
                    try {
                        if (g = a.parentNode === l || a.parentNode === m.document.head)
                            b = a.getAttribute("property").replace(n, ""),
                            c = a.getAttribute("content"),
                            f[b] ? h.isArray(f[b]) ? f[b].push(c) : f[b] = [f[b], c] : f[b] = c
                    } catch (t) {}
                }, d);
            else
                return null;
      ...
      , jc = I.inherit({
        ...
        getMeta: function() {
            ...
            var c = h.map(function(c) {
                if (a.isRemovedFromDoc(c.element)) {
                    ...
                    c.node && h.isFunction(c.node.getBoundingClientRect) && (c = c.node.getBoundingClientRect(),
                    d.x = Math.round(c.left) + a.scroll.x,
                    d.y = Math.round(c.top) + a.scroll.y,
                    d.width = Math.round(c.width),
                    d.height = Math.round(c.height));
                return d
            }, this.articles);
            h.map(function(b) {
        ...
        isRemovedFromDoc: function(a) {
            return w.closest(a, "html") !== m.document.documentElement
        },
        ...
        send: function() {
            ...
            S.log("Publisher content info found:", a),
            h.arrayEvery(this.articles, function(a) {
                a.sended = !0;
                return 1
            }))
        },
        start: function(a) {
            ...
            S.log('Publishers analytics schema "' + a.schema + '"'),
        ...
        trigger: function(a, b) {
            ...
            if (h.inArray(this.activeEvents, c)) {
                ...
                this.meta && this.scroll && this.viewbox && h.arrayEvery(this.articles, function(a) {
                    if (this.isRemovedFromDoc(a.element))
                        return 1;
                    var b = h.filter(function(b) {
                        return b.id === a.id
                    }, this.meta).pop();
                    if (!b)
                        return ua(Error("Can't find meta"), "p.t"),
                        1;
      ...
      , Db = I.inherit({
        ...
        _initComponent: F(function() {
            ...
            "b" !== d && (this._formRecorder = new Ob(this.protocol,this.counterId,this.counterType,this.hid,this.globalConfig),
        ...
        start: F(function(a, b) {
            ...
            if (this._recorder) {
                ...
                this._eventsBuffer.setWVType(this._buffer instanceof Bb ? 5 : 4),
                ...
                if (d) {
                    ...
                    d.iterate ? h.forEachKey(f, function(a, d) {
                        ...
                        for (l = 0; l < h.length; l++)
                            this.executor.addAsyncItem(h[l].addData, h[l], f, [n, d, c, f, b], "send." + (d ? d.type || d.group || "" : "empty"))
        ...
        _getStorage: function() {
            this._storage || (this._storage = new T({
                counterId: this.counterId
            }));
      ...
      , Eb = {
        ...
        handle: function(a) {
            ...
            "init" == d ? (d = "yaCounter" + c,
            m[d] || (a = h.mixin(a[2] || {}, {
                id: +c
            }),
            m[d] = new m.Ya[this.constructorName](a))) : h.inArray(this.counters, b) && f && f[d] ? (a = [].slice.call(a, 2),
            f[d].apply(f, a)) : h.inArray(this.counters, b) || (this.waitPool[b] || (this.waitPool[b] = []),
            this.waitPool[b].push(a));
            return 1
        },
        subscribe: function(a) {
            a && (this.counters.push(a),
            this.waitPool[a] && (h.arrayEvery(this.waitPool[a], this.handle, this),
    ...
    var kc = wa.inherit({
        ...
        request: function(a, b, c, d) {
            var f = !1
              , l = h.getNativeFunction("createElement", u)("script");
            this.timeout && h.setTimeout(function() {
                f || (f = !0,
                w.removeNode(l),
                c.call(d, !1))
            ...
            n || (n = u.createElement("head"),
            u.documentElement.appendChild(n));
            h.async(function() {
      ...
      , pb = Ra.inherit({
        ...
        sendHit: function(a) {
            ...
            b.ilt = na.encode(Qa.encode(h.trim(c, Gb))));
      ...
      , Hb = I.inherit({
        ...
        hit: function(a, b) {
            ...
            a(f)) : (this.globalConfig.set("fakeHit", function(a) {
                l.push(a)
            }),
      ...
      , Ib = I.inherit({
        ...
        _initComponent: function() {
            ...
            h.forEachKey(this.partners, function(a, c) {
                c.regex.test(m.location.hostname) && (this.syncTlds[c.tld] || (this.syncTlds[c.tld] = []),
        ...
        sync: function(a) {
            ...
            if (x.isIframe())
                return a();
            this._is() ? a() : (d && b._syncAdmetrica(),
            c ? (this._setStatus(!0),
            d ? this._getCn().hit(function() {
                b._sync(c, a)
            }) : a()) : a());
            d && this._addMda()
        },
      ...
      , mc = function(a, b) {
        0 === parseFloat(a.c_recp) && (Jb(b),
        b.s.set("ymoo" + b.k, v.getMinutes()))
    }
      , nc = function(a) {
        var b = v.getMinutes(), c;
        a.s.isEnabled() && (c = a.s.get("ymoo" + a.k)) && 30 > b - c && Jb(a)
    }
      , oc = Wa.inherit({
        id: "RawBodyXHR",
        index: 9,
    ...
    var Sa = {
        ...
        save: function(a, b) {
            this._getReq().request(this._url + Ca.stringify({
                key: a,
                value: h.toJSON(b)
            }));
            this._getLs().set(a, b)
      ...
      , pc = {
        ...
        _enabled: function(a, b, c) {
            if (!(60 < v.getMinutes() - Sa.getNum("ds")) || this._is() || h.isDev(this.globalConfig))
                return !1;
            a = 0 === b && 0 <= h.arrayIndexOf([39370095, 1282253, 29302335, 43653484, 41734944, 31048081, 16443139, 27737346, 41870499, 33911514, 30744873, 5564395, 2580487], a);
        ...
        getTarget: function(a) {
            ...
            try {
                if (b = a.target || a.srcElement)
                    !b.ownerDocument && b.documentElement ? b = b.documentElement : b.ownerDocument !== u && (b = null)
            } catch (c) {}
            return b
        },
    ...
    X.dispatchCustomEvent = F(function(a, b) {
        var c;
        b = b || u;
        if (c = h.getNativeFunction("createEvent", u)("Event"))
            c.initEvent(a, !1, !1),
            h.getNativeFunction("dispatchEvent", b)(c)
    }, "evt.dispatch");
    var Za = {
        lastReferrer: null
    }
      , Ia = I.inherit({
        ...
        waitPool: [],
        destruct: function() {
            this.frameConnector && this.frameConnector.destruct && (this.frameConnector.destruct(),
            this._send = function() {}
            ,
            this.waitPool = [],
        ...
        initUserLayer: function() {
            ...
            if (this.prefsEcommerce || this.prefsUseDataLayer)
                this._overridePush(this.prefsEcommerce) || (h.isString(this.prefsEcommerce) && (this.dataLayerName = this.prefsEcommerce),
                a = this.dataLayerName,
                this._tryTimeout = h.bind(this._tryTimeout, this),
                this._tryTimeout()),
            ...
            for (f = a.length; l < f; l++) {
                if ((d = a[l]) && d.ymetrikaEvent) {
                    ...
                    if ("params" === g.type && g.data) {
                        g.sended || (g.sended = []);
                        if (g.counter)
                            this.counter && this.counter.params && this.counterId == g.counter && (this.onCookies(function(a) {
                                this.counter.params(a.data)
                            }, this, h.mixin({}, g)),
                            g.sended.push(this.counterId));
                        else
                            this.onCookies(function(a) {
                                h.forEachKey(this.globalConfig.get("counters"), function(b, c) {
                                    var d = b.split(":")[0];
                                    !h.inArray(a.sended, d) && c && c.params && (c.params(a.data),
                                    a.sended.push(d))
                                }, this)
                            }, this, h.mixin({}, g));
        ...
        if (a.length) {
            ...
            for (d = 0; d < f.length; d++)
                if (f[d]) {
                    var l = f[d].split("\x3d");
                    if (l[0]) {
                        var g = h.safeDecodeURIComponent(l[0]);
    ...
    var Kb = "GDPR-ok GDPR-cross GDPR-cancel GDPR-skip GDPR-frame-skip GDPR-frame-ya GDPR-frame-noya GDPR-open-start GDPR-eu-skip GDPR-open-fail GDPR-open-success GDPR-cookie-success GDPR-cookie-fail GDPR-skip-login GDPR-skip-domain GDPR-skip-na GDPR-skip-eu-na GDPR-skip-wv GDPR-settings GDPR-ok-view-default GDPR-ok-view-detailed 21 22 23".split(" ")
      ...
      , xa = I.inherit({
        ...
        handle: function() {
            ...
            if (!this.enabled && ("0" === l || x.isSafariWebView() || x.isAndroidWebView() || h.inArray(qc, m.location.href.split("?")[0]) || !qa() || f.read("yandex_login") || this.disable))
                return f.read("yandex_login") ? (this.trigger("GDPR-skip-login"),
                f.create("gdpr", "0", 525600)) : qa() ? "0" === l ? this.trigger("GDPR-skip") : x.isSafariWebView() || x.isAndroidWebView() ? this.trigger("GDPR-skip-wv") : this.trigger("GDPR-skip-na") : this.trigger("GDPR-skip-domain"),
                this.realise(t, b);
            this.globalConfig.set(this.globalKey, function(a, c) {
                ...
                b.size + d < n.MAX_SIZE ? (b.push(a),
                b.size += d) : h.warning("GDPR buffer is exceeded")
            });
            a.hit(function(a) {
                if (a.params.eu || g || n.enabled)
                    ...
                    n.frameConnector.isIframe) {
                        n.frameConnector.sendToParents({
                            ...
                            var d = !1;
                            clearTimeout(m);
                            c[0].isYandex ? (n.trigger("GDPR-frame-ya"),
                            n.frameConnector.addHandler("GDPR-ok", function() {
                                d || (f.create("gdpr", "0", 525600),
                                n.realise(c, b),
                                d = !0)
                            }),
                        ...
                        n.askGDPR(l, d, c, t, b, f);
                else
                    return a.params.eu ? n.trigger("GDPR-skip-eu-na") : (f.create("gdpr", "0"),
                    n.trigger("GDPR-eu-skip")),
                    n.realise(t, b)
            })
        }
    });
    ...
    xa.getState = function(a) {
        ...
        b && (a += "-" + (h.inArray(["0", "1"], b) ? b : "2")),
        a) : ""
    }
    ;
    var rc = {
        init: function(a, b, c) {
            "22663942" == c && (c = u.createElement("img"),
    ...
    x.isPrivate = F(function(a) {
        ...
        a = h.bind(a, null, 1);
        if (h.isFunction(m.webkitRequestFileSystem) && !x.isAndroid())
            return m.webkitRequestFileSystem(0, 0, b, a);
        if (x.isFF())
            return "undefined" == typeof navigator.serviceWorker ? a() : b();
        if (x.isSafari() && h.isFunction(m.openDatabase))
            try {
                m.openDatabase(null, null, null, null),
                b()
            } catch (c) {
                a()
            }
        else {
            if (m.indexedDB || !m.PointerEvent && !m.MSPointerEvent)
                return b();
            a()
        }
    }, "isPrivate");
    ...
    var sc = U.inherit({
      ...
      , tc = I.inherit({
        ...
        start: function() {
            if (!this._start)
                y.on(u, "click", this._handler, this);
            this._start = !0
        },
        stop: function() {
        ...
        _isTrackingClick: function(a) {
            var b;
            if (m.ymDisabledClickmap || h.isMetrikaPlayer() || !a.el)
                return !1;
            var c = a.el.tagName;
        ...
        _getElPath: function(a) {
            for (var b = ""; a && a.parentNode && "BODY" != a.tagName && "HTML" != a.tagName; )
                ...
                b += w.getElementNeighborPosition(a) || "",
                a = a.parentNode;
      ...
      , Lb = I.inherit({
        ...
        checkAssessor: function() {
            ...
            h.forEachKey(b, function(c) {
                if ((new RegExp(c)).test(m.location.hash) || T.get(this.ASSESSOR_COOKIE + c))
                    T.set(this.ASSESSOR_COOKIE + c),
                    a.push(b[c])
            }, this);
            return a
        },
        _initComponent: function() {
            ...
            this._executedMsgs = {},
            y.on(m, "message", this._onMessage, this),
        ...
        _buildRemoteIframe: function(a) {
            var b = h.getNativeFunction("createElement", u)("div")
              , c = w.getBody() || u.documentElement;
            if (c) {
                ...
                b.removeChild(d),
                (c = b.createShadowRoot ? b.createShadowRoot() : b.webkitCreateShadowRoot()) && c.appendChild(d),
                m._ym__remoteIframeContainer = b) : (c.appendChild(d),
                m._ym__remoteIframeContainer = d)
            }
        },
        ...
        _onMessage: function(a) {
            ...
            b && this._isAllowedOrigin(b) && (b = R.parse(a.data)) && "appendremote" === b.action && this._isAllowedStatic(h.parseUrl(b.domain).host) && this._isAllowedLang(b.lang) && !this._executedMsgs[b.id] && (this._executedMsgs[b.id] = !0,
            m._ym__postMessageEvent = a,
            m._ym__inpageMode = b.inpageMode,
            m._ym__initMessage = b.initMessage,
    ...
    var vc = {
        ...
        checkChildrenData: function(a, b) {
            h.arrayEvery(this.dataToSend.childs, function(c) {
                -1 == h.arrayIndexOf(c.tryTo, b.counterId) && (c.tryTo.push(b.counterId),
                h.mixin(c.data, {
        ...
        sendToIframe: function(a, b, c, d) {
            ...
            this.pending[l] = h.bind(c, d || this),
            h.setTimeout(function() {
                delete f.pending[l]
            ...
            if (f && f.substring && f.substring(0, this.nameSpace.length) == this.nameSpace) {
                ...
                if ((d = d.data) && d.type && this.handlers[d.type] && "0" === b[this.DIR_INDEX]) {
                    if (!d.toCounter || d.toCounter == this.counterId) {
                        ...
                        d.counterId && this.checkFrame(a.source) && (l = this.trigger(d.type, a, d),
                        a.source.postMessage(this.genMessage(l, [b[0], b[1], d.counterId]).string, "*"))
                    }
                } else
                    b[this.DIR_INDEX] == this.counterId && h.isArray(d) && h.arrayEvery(d, function(a) {
                        return a.counterId && a.hid
                    }) && (a = this.pending[[b[0], b[1]].join(this.spliter)]) && a.apply(this, d)
            }
        }
    }), M = L(), gb = v.getTimezone(), hb = v.getTimestamp(), ia = m.screen, cc = 64, lb = x.isIE() ? 512 : 2048, dc = x.isIE() ? 512 : 2048, zb = x.isIE() ? 100 : 400, Gb = 100, kb = "noindex", Nb = /\.(3gp|7z|aac|ac3|acs|ai|avi|ape|apk|asf|bmp|bz2|cab|cdr|crc32|css|csv|cue|divx|dmg|djvu?|doc(x|m|b)?|emf|eps|exe|flac?|flv|iso|swf|gif|t?gz|jpe?g?|js|m3u8?|m4a|mp(3|4|e?g?)|m4v|md5|mkv|mov|msi|ods|og(g|m|v)|psd|rar|rss|rtf|sea|sfv|sit|sha1|svg|tar|tif?f|torrent|ts|txt|vob|wave?|wma|wmv|wmf|webm|ppt(x|m|b)?|xls(x|m|b)?|pdf|phps|png|xpi|g?zip)$/i, wc = new Ja({
        sampling: .01
    }), xc = +new Date, oa = "Metrika", qb, db, za = function() {
        return "1904"
    }();
    ...
    m.Ya[oa] = function(a, b, c, d) {
        ...
        return F(function() {
            function l(a) {
                ...
                if ((new RegExp("^https?://" + M.host + "/")).test(b))
                    return !1;
                var e = a.patterns;
                for (c = 0; c < e.length; c++) {
                    ...
                    if (b.match(f))
                        ...
                        f.length) {
                            ...
                            for (d = 0; d < f.length; d++)
                                if (g == h.safeDecodeURIComponent(f[d]))
                                    return !0
                        } else
                            return !0
                }
            ...
            function g(a, b) {
                ...
                if (a && "string" != typeof a && a.length)
                    for (d = 0; d < a.length; d++) {
                        ...
                        e = e.slice(1);
                        if ("#" == g) {
                            if (g = u.getElementById(e))
                                c = !0,
                                b && fa.unshift([g, g.innerHTML]),
                                g.innerHTML = f
                        } else if ("." == g)
                            for (g = w.getElementsByClassName(e),
                            e = 0; e < g.length; e++) {
                                c = !0;
                                var h = g[e]
                                  , k = f;
            ...
            function t(b, c, d) {
                return F(function() {
                    if (!f.isDestructing())
                        return d && wc.log("privateFields", c, a, 1),
                        b.apply(this, arguments)
                }, c || "")
            }
            function p() {
                var p = !1
                  , t = !1;
                ra || (t = U.initCookie(va),
                Ea.userInfo = U._userID,
                yb.init(C));
                Ea.initPU(P, C);
                x.isAndroidWebView() || Ea.initPP(C);
                U.retransmit(C);
                wa && rc.init(wa, Z, a);
                C.get("pri") != A || x.isAndroidWebView() || (C.setSafe("pri", null),
                x.isPrivate(F(function(a) {
                    C.set("pri", a)
                }, "privCb")));
                Eb.subscribe(W);
                if (C.get("hitParam")[W]) {
                    if (1 != c || C.get("counters")[W])
                        return !1;
                    p = !0
                }
                C.get("counters")[W] = f;
                            ...
                            callback: function(k, p) {
                                ...
                                if (!f.isDestructing()) {
                                    ...
                                    if (t) {
                                                ...
                                                for (ka = 0; ka < aa.length; ka++) {
                                                    ...
                                                    if ("ref" == w.type)
                                                        ...
                                                        for (v = 0; v < G.length; v++)
                                                            Aa["utm_" + G[v]] && (F[G[v]] = Aa["utm_" + G[v]]);
                                                        var H = z ? "direct.yandex.ru" : E && E.service || F.source;
                                                        v = !1;
                                                        if (!v && B && B.length)
                                                        ...
                                                        if (!v && !x.yandex_direct && D && D.length)
                                                            for (B = 0; B < D.length; B++)
                                                                if ((new RegExp(D[B],"i")).test(Ha)) {
                                                                    v = !0;
                                                                    break
                                                                }
                                                        !v && x.google_adwords && Aa.gclid && (v = !0);
                                                        if (v && w && w.length && (v = !1,
                                                        z = z || E && E.campaign || F && F.campaign))
                                        ...
                                        aa && t ? (q.create("mp2_substs", h.toJSON(t)),
                                        q = g(t),
                                        f.params("__ym", q ? "mp_trackid" : "mp_trackid_bad", aa)) : n()
                                    } else
                                        n();
                ...
                0 != h.keys(N).length && (ja && ja.initUserLayer(),
                N.enableAll ? (q(!1),
                e(!0),
                E()) : (N.clickmap && e(N.clickmap),
                N.trackLinks && q(N.trackLinks),
                N.accurateTrackBounce && E(N.accurateTrackBounce)),
                N.triggerEvent && h.async(function() {
            ...
            function k(a) {
                if (f._trackLinks && f._trackLinks.on) {
                    ...
                    if (c && !w.classNameExists(a, "ym-disable-tracklink")) {
                        ...
                        var g = tb(a);
                        g = c === g ? "" : g;
                        if (w.classNameExists(a, "ym-external-link"))
                            K.sendClickLink({
                                url: c,
                                title: g,
                                modes: d
                            ...
                            b = b.hostname;
                            (k ? k.replace(/^www\./, "") : "").toLowerCase() == (b ? b.replace(/^www\./, "") : "").toLowerCase() ? d.dl ? (d.ln = !1,
                            K.sendClickLink({
                                url: c,
                                title: g,
                                modes: d
                            ...
                            ya.set("pai", d.pai),
                            g && g !== c && ya.set("il", h.trim(g, Gb))) : c && -1 !== c.search(/^ *(data|javascript):/i) || (d.ut = kb,
                            K.sendClickLink({
                                url: c,
                                title: g,
                                modes: d
            ...
            function D(a, b) {
                ...
                function e(a) {
                    ...
                    for (b = 0; b < r.length; b += 3)
                        if (a)
                            y.on(r[b], r[b + 1], r[b + 2], {
                                name: "tabTrack"
                            });
                        else
                            y.un(r[b], r[b + 1], r[b + 2])
                }
                var f = !1
                  , g = !1
                  , k = !0
            ...
            function z(a) {
                ...
                (function Na() {
                    ...
                    d !== c && (a(),
                    c = d);
                    za = h.setTimeout(Na, 200, "trackHash")
                }
                )()
            }
            function G(a) {
                if (!1 === a)
                    Ba && ("onhashchange"in m ? y.un(m, "hashchange", I) : h.clearTimeout(za),
                    Ba = !1);
                else if (a = I,
                !Ba) {
                    if ("onhashchange"in m)
                        y.on(m, "hashchange", a);
                    else
                        z(a);
                    Ba = !0
            ...
            function J(a, b, c) {
                ...
                a && (b.push(a),
                c = c || {},
                h.isFunction(c.callback) && (b.push(c.callback),
                c.ctx && b.push(c.ctx)));
            ...
            if (!m["disableYaCounter" + a]) {
                ...
                var W = a + ":" + c;
                if (C.get("counters")[W])
                    return S.log("Duplicate counter " + W + " initialization"),
                    C.get("counters")[W];
                var Z = C.get("hitId");
                var P = new Mb({
                    counterId: a,
                        ...
                        if (m.performance && "function" === typeof performance.getEntriesByType) {
                            ...
                            if (!c || !d) {
                                var e = {
                                    ...
                                    1417229093: 1,
                                    138396985: 1
                                }, f = performance.getEntriesByType("resource"), g = {}, k = {}, l = {
                                    counterId: 51533966
                                }, n = {}, q;
                ...
                f.hit = t(function(b, c, d, e, g, k) {
                    (b = b && h.isFunction(b.toString) ? b.toString() : !1) ? (h.isObject(c) && (d = c.referer,
                    e = c.params,
                    g = c.callback,
                    k = c.ctx,
                    c = c.title),
                    O = b,
                    S.log("PageView. Counter " + a, ". URL: " + b, ". Referrer: " + d, ". Params: ", e),
                    K.sendHit({
                        url: b,
                        title: c,
                        hasPrerender: ma,
                ...
                f.params = t(function(b) {
                    ...
                    if (b) {
                        ...
                        h.warning("Wrong params");
                    return f
                }, "counter.params");
                P.addHandler("pluginInfo", function() {
                    return N
                }, this);
                ...
                f.addFileExtension = t(function(a) {
                    if (!a)
                        return h.warning("Empty extension"),
                        f;
                ...
                var Q = {
                    ...
                    parseValidate: function(a, b) {
                        ...
                        for (d in b)
                            b.hasOwnProperty(d) && -1 === h.arrayIndexOf(this.requiredEcommerceFields, d) && (c[a].actionField || (c[a].actionField = {}),
                    ...
                    validate: function(a, b) {
                        ...
                        if (h.isObject(b))
                            ...
                            case "add":
                            case "remove":
                                h.isArray(b.goods) && b.goods.length ? (c = h.arrayEvery(b.goods, function(a) {
                ...
                f.destruct = t(function() {
                    ...
                    e(!1);
                    try {
                        delete m["yaCounter" + a],
                        delete C.get("counters")[W],
                        delete C.get("hitParam")[W]
                    } catch (aa) {}
                });
                ...
                if (a) {
                    ...
                    if ("prerender" === u.webkitVisibilityState || "prerender" === u.visibilityState) {
                        K.sendPrerenderHit({
                            url: O,
                            vParams: b,
                            title: w.getDocumentTitle(),
                        ...
                        var la = function() {
                            "prerender" !== u.webkitVisibilityState && "prerender" !== u.visibilityState && (y.un(u, "webkitvisibilitychange,visibilitychange", la),
                            B(!0))
                        };
